...
impl ThreadRequestProcessor {
    ...
    pub(crate) async fn thread_projection_detach(
            ...
            .await
        {
            ...
            ProjectionDetachResult::NotSubscribed => ThreadProjectionDetachStatus::NotSubscribed,
            ProjectionDetachResult::NotLoaded => ThreadProjectionDetachStatus::NotLoaded,
        };
    ...
    async fn read_thread_projection_snapshot(
        &self,
        thread_id: ThreadId,
    ) -> Result<Thread, ThreadReadViewError> {
        match self
