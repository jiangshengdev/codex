...
The TypeScript SDK wraps the `codex` CLI from `@jiangshengdev/codex`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @jiangshengdev/codex-sdk
```
