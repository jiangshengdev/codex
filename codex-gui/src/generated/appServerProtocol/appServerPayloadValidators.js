...
function validate19(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (!(data === "review" || data === "compact" || data === "memory_consolidation")) {
    const err1 = { instancePath, schemaPath: "#/oneOf/0/enum", keyword: "enum", params: { allowedValues: schema22.oneOf[0].enum } };
    if (vErrors === null) {
      vErrors = [err1];
    } else {
      vErrors.push(err1);
                ...
                if (data0.depth === void 0 && (missing1 = "depth") || data0.parent_thread_id === void 0 && (missing1 = "parent_thread_id")) {
                  ...
                  if (data0.agent_nickname !== void 0) {
                    ...
                    if (typeof data1 !== "string" && data1 !== null) {
                      const err5 = { instancePath: instancePath + "/thread_spawn/agent_nickname", schemaPath: "#/oneOf/1/properties/thread_spawn/properties/agent_nickname/type", keyword: "type", params: { type: schema22.oneOf[1].properties.thread_spawn.properties.agent_nickname.type } };
                      if (vErrors === null) {
                        vErrors = [err5];
                      } else {
                        vErrors.push(err5);
                    ...
                    if (valid2) {
                      if (data0.agent_role !== void 0) {
                        ...
                        if (typeof data3 !== "string" && data3 !== null) {
                          const err9 = { instancePath: instancePath + "/thread_spawn/agent_role", schemaPath: "#/oneOf/1/properties/thread_spawn/properties/agent_role/type", keyword: "type", params: { type: schema22.oneOf[1].properties.thread_spawn.properties.agent_role.type } };
                          if (vErrors === null) {
                            vErrors = [err9];
                          } else {
                            vErrors.push(err9);
...
function validate18(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (!(data === "cli" || data === "vscode" || data === "exec" || data === "appServer" || data === "unknown")) {
    const err1 = { instancePath, schemaPath: "#/oneOf/0/enum", keyword: "enum", params: { allowedValues: schema21.oneOf[0].enum } };
    if (vErrors === null) {
      vErrors = [err1];
    } else {
      vErrors.push(err1);
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.type === void 0 && (missing0 = "type")) {
        ...
        if (data.type !== void 0) {
          ...
          if (!(data0 === "notLoaded")) {
            const err2 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema25.oneOf[0].properties.type.enum } };
            if (vErrors === null) {
              vErrors = [err2];
            } else {
              vErrors.push(err2);
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.type === void 0 && (missing1 = "type")) {
        ...
        if (data.type !== void 0) {
          ...
          if (!(data1 === "idle")) {
            const err6 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema25.oneOf[1].properties.type.enum } };
            if (vErrors === null) {
              vErrors = [err6];
            } else {
              vErrors.push(err6);
        ...
        if (data.type === void 0 && (missing2 = "type")) {
          ...
          if (data.type !== void 0) {
            ...
            if (!(data2 === "systemError")) {
              const err10 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema25.oneOf[2].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err10];
              } else {
                vErrors.push(err10);
          ...
          if (data.activeFlags === void 0 && (missing3 = "activeFlags") || data.type === void 0 && (missing3 = "type")) {
                ...
                if (Array.isArray(data3)) {
                  ...
                  for (let i0 = 0; i0 < len0; i0++) {
                    ...
                    if (!(data4 === "waitingOnApproval" || data4 === "waitingOnUserInput")) {
                      const err14 = { instancePath: instancePath + "/activeFlags/" + i0, schemaPath: "#/definitions/v2/ThreadActiveFlag/enum", keyword: "enum", params: { allowedValues: schema26.enum } };
                      if (vErrors === null) {
                        vErrors = [err14];
                      } else {
                        vErrors.push(err14);
            ...
            if (valid4) {
              if (data.type !== void 0) {
                ...
                if (!(data5 === "active")) {
                  const err17 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema25.oneOf[3].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err17];
                  } else {
                    vErrors.push(err17);
...
function validate26(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (!(data === "contextWindowExceeded" || data === "sessionBudgetExceeded" || data === "usageLimitExceeded" || data === "serverOverloaded" || data === "cyberPolicy" || data === "internalServerError" || data === "unauthorized" || data === "badRequest" || data === "threadRollbackFailed" || data === "sandboxError" || data === "other")) {
    const err1 = { instancePath, schemaPath: "#/oneOf/0/enum", keyword: "enum", params: { allowedValues: schema30.oneOf[0].enum } };
    if (vErrors === null) {
      vErrors = [err1];
    } else {
      vErrors.push(err1);
              ...
              if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
                if (data0.httpStatusCode !== void 0) {
                  ...
                  if (!(typeof data1 == "number" && (!(data1 % 1) && !isNaN(data1)) && isFinite(data1)) && data1 !== null) {
                    const err4 = { instancePath: instancePath + "/httpConnectionFailed/httpStatusCode", schemaPath: "#/oneOf/1/properties/httpConnectionFailed/properties/httpStatusCode/type", keyword: "type", params: { type: schema30.oneOf[1].properties.httpConnectionFailed.properties.httpStatusCode.type } };
                    if (vErrors === null) {
                      vErrors = [err4];
                    } else {
                      vErrors.push(err4);
                ...
                if (data2 && typeof data2 == "object" && !Array.isArray(data2)) {
                  if (data2.httpStatusCode !== void 0) {
                    ...
                    if (!(typeof data3 == "number" && (!(data3 % 1) && !isNaN(data3)) && isFinite(data3)) && data3 !== null) {
                      const err10 = { instancePath: instancePath + "/responseStreamConnectionFailed/httpStatusCode", schemaPath: "#/oneOf/2/properties/responseStreamConnectionFailed/properties/httpStatusCode/type", keyword: "type", params: { type: schema30.oneOf[2].properties.responseStreamConnectionFailed.properties.httpStatusCode.type } };
                      if (vErrors === null) {
                        vErrors = [err10];
                      } else {
                        vErrors.push(err10);
                  ...
                  if (data4 && typeof data4 == "object" && !Array.isArray(data4)) {
                    if (data4.httpStatusCode !== void 0) {
                      ...
                      if (!(typeof data5 == "number" && (!(data5 % 1) && !isNaN(data5)) && isFinite(data5)) && data5 !== null) {
                        const err16 = { instancePath: instancePath + "/responseStreamDisconnected/httpStatusCode", schemaPath: "#/oneOf/3/properties/responseStreamDisconnected/properties/httpStatusCode/type", keyword: "type", params: { type: schema30.oneOf[3].properties.responseStreamDisconnected.properties.httpStatusCode.type } };
                        if (vErrors === null) {
                          vErrors = [err16];
                        } else {
                          vErrors.push(err16);
                    ...
                    if (data6 && typeof data6 == "object" && !Array.isArray(data6)) {
                      if (data6.httpStatusCode !== void 0) {
                        ...
                        if (!(typeof data7 == "number" && (!(data7 % 1) && !isNaN(data7)) && isFinite(data7)) && data7 !== null) {
                          const err22 = { instancePath: instancePath + "/responseTooManyFailedAttempts/httpStatusCode", schemaPath: "#/oneOf/4/properties/responseTooManyFailedAttempts/properties/httpStatusCode/type", keyword: "type", params: { type: schema30.oneOf[4].properties.responseTooManyFailedAttempts.properties.httpStatusCode.type } };
                          if (vErrors === null) {
                            vErrors = [err22];
                          } else {
                            vErrors.push(err22);
                        ...
                        if (data8.turnKind === void 0 && (missing5 = "turnKind")) {
                          ...
                          if (data8.turnKind !== void 0) {
                            ...
                            if (!(data9 === "review" || data9 === "compact")) {
                              const err30 = { instancePath: instancePath + "/activeTurnNotSteerable/turnKind", schemaPath: "#/definitions/v2/NonSteerableTurnKind/enum", keyword: "enum", params: { allowedValues: schema31.enum } };
                              if (vErrors === null) {
                                vErrors = [err30];
                              } else {
                                vErrors.push(err30);
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.message === void 0 && (missing0 = "message")) {
        validate25.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 } }];
        return false;
      } else {
        if (data.additionalDetails !== void 0) {
          ...
          if (typeof data0 !== "string" && data0 !== null) {
            validate25.errors = [{ instancePath: instancePath + "/additionalDetails", schemaPath: "#/properties/additionalDetails/type", keyword: "type", params: { type: schema29.properties.additionalDetails.type } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
          ...
          if (valid0) {
            if (data.message !== void 0) {
              ...
              if (typeof data.message !== "string") {
                validate25.errors = [{ instancePath: instancePath + "/message", schemaPath: "#/properties/message/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
      ...
      validate25.errors = [{ instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" } }];
      return false;
    }
  }
  validate25.errors = vErrors;
...
var schema50 = { "properties": { "actionName": { "type": ["string", "null"] }, "appName": { "type": ["string", "null"] }, "connectorId": { "type": "string" }, "linkId": { "type": ["string", "null"] }, "resourceUri": { "type": ["string", "null"] } }, "required": ["connectorId"], "type": "object" };
      ...
      if (data.byteRange === void 0 && (missing0 = "byteRange")) {
          ...
          if (errors === _errs3) {
            if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
              ...
              if (data0.end === void 0 && (missing1 = "end") || data0.start === void 0 && (missing1 = "start")) {
                validate31.errors = [{ instancePath: instancePath + "/byteRange", schemaPath: "#/definitions/v2/ByteRange/required", keyword: "required", params: { missingProperty: missing1 } }];
                return false;
              } else {
                if (data0.end !== void 0) {
                  let data1 = data0.end;
                  ...
                  if (!(typeof data1 == "number" && (!(data1 % 1) && !isNaN(data1)) && isFinite(data1))) {
                    validate31.errors = [{ instancePath: instancePath + "/byteRange/end", schemaPath: "#/definitions/v2/ByteRange/properties/end/type", keyword: "type", params: { type: "integer" } }];
                    return false;
                  }
                  if (errors === _errs5) {
                    if (typeof data1 == "number" && isFinite(data1)) {
                      if (data1 < 0 || isNaN(data1)) {
                        validate31.errors = [{ instancePath: instancePath + "/byteRange/end", schemaPath: "#/definitions/v2/ByteRange/properties/end/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 } }];
                        return false;
                      }
                    }
                  }
                ...
                if (valid3) {
                  if (data0.start !== void 0) {
                    ...
                    if (!(typeof data2 == "number" && (!(data2 % 1) && !isNaN(data2)) && isFinite(data2))) {
                      validate31.errors = [{ instancePath: instancePath + "/byteRange/start", schemaPath: "#/definitions/v2/ByteRange/properties/start/type", keyword: "type", params: { type: "integer" } }];
                      return false;
                    }
                    if (errors === _errs7) {
                      if (typeof data2 == "number" && isFinite(data2)) {
                        if (data2 < 0 || isNaN(data2)) {
                          validate31.errors = [{ instancePath: instancePath + "/byteRange/start", schemaPath: "#/definitions/v2/ByteRange/properties/start/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 } }];
                          return false;
                        }
                      }
                    }
              ...
              validate31.errors = [{ instancePath: instancePath + "/byteRange", schemaPath: "#/definitions/v2/ByteRange/type", keyword: "type", params: { type: "object" } }];
              return false;
            }
          }
          var valid0 = _errs1 === errors;
        ...
        if (valid0) {
          if (data.placeholder !== void 0) {
            ...
            const _errs9 = errors;
            if (typeof data3 !== "string" && data3 !== null) {
              validate31.errors = [{ instancePath: instancePath + "/placeholder", schemaPath: "#/properties/placeholder/type", keyword: "type", params: { type: schema34.properties.placeholder.type } }];
              return false;
            }
            var valid0 = _errs9 === errors;
          } else {
        ...
        if (valid1) {
          ...
          if (valid1) {
            if (data.type !== void 0) {
              ...
              if (!(data3 === "text")) {
                const err4 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[0].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err4];
                } else {
                  vErrors.push(err4);
      ...
      if (data.type === void 0 && (missing1 = "type") || data.url === void 0 && (missing1 = "url")) {
        ...
        if (data.detail !== void 0) {
          ...
          if (!(data4 === "auto" || data4 === "low" || data4 === "high" || data4 === "original")) {
            const err8 = { instancePath: instancePath + "/detail", schemaPath: "#/definitions/v2/ImageDetail/enum", keyword: "enum", params: { allowedValues: schema36.enum } };
            if (vErrors === null) {
              vErrors = [err8];
            } else {
              vErrors.push(err8);
        ...
        if (valid3) {
          if (data.type !== void 0) {
            ...
            if (!(data5 === "image")) {
              const err12 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[1].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err12];
              } else {
                vErrors.push(err12);
        ...
        if (data.path === void 0 && (missing2 = "path") || data.type === void 0 && (missing2 = "type")) {
          ...
          if (data.detail !== void 0) {
            ...
            if (!(data7 === "auto" || data7 === "low" || data7 === "high" || data7 === "original")) {
              const err17 = { instancePath: instancePath + "/detail", schemaPath: "#/definitions/v2/ImageDetail/enum", keyword: "enum", params: { allowedValues: schema36.enum } };
              if (vErrors === null) {
                vErrors = [err17];
              } else {
                vErrors.push(err17);
          ...
          if (valid6) {
            ...
            if (valid6) {
              if (data.type !== void 0) {
                ...
                if (!(data9 === "localImage")) {
                  const err22 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[2].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err22];
                  } else {
                    vErrors.push(err22);
        ...
        if (data && typeof data == "object" && !Array.isArray(data)) {
          ...
          if (data.type === void 0 && (missing3 = "type") || data.url === void 0 && (missing3 = "url")) {
            ...
            if (data.type !== void 0) {
              ...
              if (!(data10 === "audio")) {
                const err26 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[3].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err26];
                } else {
                  vErrors.push(err26);
              ...
              if (valid10) {
                if (data.type !== void 0) {
                  ...
                  if (!(data13 === "localAudio")) {
                    const err32 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/4/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[4].properties.type.enum } };
                    if (vErrors === null) {
                      vErrors = [err32];
                    } else {
                      vErrors.push(err32);
                ...
                if (valid11) {
                  ...
                  if (valid11) {
                    if (data.type !== void 0) {
                      ...
                      if (!(data16 === "skill")) {
                        const err38 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/5/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[5].properties.type.enum } };
                        if (vErrors === null) {
                          vErrors = [err38];
                        } else {
                          vErrors.push(err38);
                  ...
                  if (valid12) {
                    ...
                    if (valid12) {
                      if (data.type !== void 0) {
                        ...
                        if (!(data19 === "mention")) {
                          const err44 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/6/properties/type/enum", keyword: "enum", params: { allowedValues: schema33.oneOf[6].properties.type.enum } };
                          if (vErrors === null) {
                            vErrors = [err44];
                          } else {
                            vErrors.push(err44);
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.entries === void 0 && (missing0 = "entries") || data.threadIds === void 0 && (missing0 = "threadIds")) {
        validate34.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 } }];
        return false;
      } else {
        if (data.entries !== void 0) {
          ...
          if (errors === _errs1) {
            if (Array.isArray(data0)) {
                ...
                if (errors === _errs4) {
                  if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                    ...
                    if (data1.lineEnd === void 0 && (missing1 = "lineEnd") || data1.lineStart === void 0 && (missing1 = "lineStart") || data1.note === void 0 && (missing1 = "note") || data1.path === void 0 && (missing1 = "path")) {
                      validate34.errors = [{ instancePath: instancePath + "/entries/" + i0, schemaPath: "#/definitions/v2/MemoryCitationEntry/required", keyword: "required", params: { missingProperty: missing1 } }];
                      return false;
                    } else {
                      if (data1.lineEnd !== void 0) {
                        ...
                        const _errs6 = errors;
                        if (!(typeof data2 == "number" && (!(data2 % 1) && !isNaN(data2)) && isFinite(data2))) {
                          validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/lineEnd", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/lineEnd/type", keyword: "type", params: { type: "integer" } }];
                          return false;
                        }
                        if (errors === _errs6) {
                          if (typeof data2 == "number" && isFinite(data2)) {
                            if (data2 < 0 || isNaN(data2)) {
                              validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/lineEnd", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/lineEnd/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 } }];
                              return false;
                            }
                          }
                        }
                      ...
                      if (valid3) {
                        if (data1.lineStart !== void 0) {
                          ...
                          if (!(typeof data3 == "number" && (!(data3 % 1) && !isNaN(data3)) && isFinite(data3))) {
                            validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/lineStart", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/lineStart/type", keyword: "type", params: { type: "integer" } }];
                            return false;
                          }
                          if (errors === _errs8) {
                            if (typeof data3 == "number" && isFinite(data3)) {
                              if (data3 < 0 || isNaN(data3)) {
                                validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/lineStart", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/lineStart/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 } }];
                                return false;
                              }
                            }
                          }
                        ...
                        if (valid3) {
                          if (data1.note !== void 0) {
                            ...
                            if (typeof data1.note !== "string") {
                              validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/note", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/note/type", keyword: "type", params: { type: "string" } }];
                              return false;
                            }
                          ...
                          if (valid3) {
                            if (data1.path !== void 0) {
                              ...
                              if (typeof data1.path !== "string") {
                                validate34.errors = [{ instancePath: instancePath + "/entries/" + i0 + "/path", schemaPath: "#/definitions/v2/MemoryCitationEntry/properties/path/type", keyword: "type", params: { type: "string" } }];
                                return false;
                              }
                              var valid3 = _errs12 === errors;
                            } else {
                    ...
                    validate34.errors = [{ instancePath: instancePath + "/entries/" + i0, schemaPath: "#/definitions/v2/MemoryCitationEntry/type", keyword: "type", params: { type: "object" } }];
                    return false;
                  }
                }
                var valid1 = _errs3 === errors;
              ...
              validate34.errors = [{ instancePath: instancePath + "/entries", schemaPath: "#/properties/entries/type", keyword: "type", params: { type: "array" } }];
              return false;
            }
          }
          var valid0 = _errs1 === errors;
              ...
              if (Array.isArray(data6)) {
                ...
                for (let i1 = 0; i1 < len1; i1++) {
                  ...
                  if (typeof data6[i1] !== "string") {
                    validate34.errors = [{ instancePath: instancePath + "/threadIds/" + i1, schemaPath: "#/properties/threadIds/items/type", keyword: "type", params: { type: "string" } }];
                    return false;
                  }
                ...
                validate34.errors = [{ instancePath: instancePath + "/threadIds", schemaPath: "#/properties/threadIds/type", keyword: "type", params: { type: "array" } }];
                return false;
              }
            }
      ...
      validate34.errors = [{ instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" } }];
      return false;
    }
  }
        ...
        if (valid1) {
          ...
          if (valid1) {
            if (data.path !== void 0) {
              const _errs7 = errors;
              if (typeof data.path !== "string") {
                const err3 = { instancePath: instancePath + "/path", schemaPath: "#/definitions/v2/AbsolutePathBuf/type", keyword: "type", params: { type: "string" } };
                if (vErrors === null) {
                  vErrors = [err3];
                } else {
                  vErrors.push(err3);
            ...
            if (valid1) {
              if (data.type !== void 0) {
                ...
                if (!(data3 === "read")) {
                  const err5 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema42.oneOf[0].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err5];
                  } else {
                    vErrors.push(err5);
        ...
        if (valid3) {
          if (data.path !== void 0) {
            ...
            if (typeof data5 !== "string" && data5 !== null) {
              const err9 = { instancePath: instancePath + "/path", schemaPath: "#/oneOf/1/properties/path/type", keyword: "type", params: { type: schema42.oneOf[1].properties.path.type } };
              if (vErrors === null) {
                vErrors = [err9];
              } else {
                vErrors.push(err9);
          ...
          if (valid3) {
            if (data.type !== void 0) {
              ...
              if (!(data6 === "listFiles")) {
                const err11 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema42.oneOf[1].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err11];
                } else {
                  vErrors.push(err11);
          ...
          if (valid4) {
            if (data.path !== void 0) {
              ...
              if (typeof data8 !== "string" && data8 !== null) {
                const err15 = { instancePath: instancePath + "/path", schemaPath: "#/oneOf/2/properties/path/type", keyword: "type", params: { type: schema42.oneOf[2].properties.path.type } };
                if (vErrors === null) {
                  vErrors = [err15];
                } else {
                  vErrors.push(err15);
            ...
            if (valid4) {
              if (data.query !== void 0) {
                ...
                if (typeof data9 !== "string" && data9 !== null) {
                  const err16 = { instancePath: instancePath + "/query", schemaPath: "#/oneOf/2/properties/query/type", keyword: "type", params: { type: schema42.oneOf[2].properties.query.type } };
                  if (vErrors === null) {
                    vErrors = [err16];
                  } else {
                    vErrors.push(err16);
              ...
              if (valid4) {
                if (data.type !== void 0) {
                  ...
                  if (!(data10 === "search")) {
                    const err18 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema42.oneOf[2].properties.type.enum } };
                    if (vErrors === null) {
                      vErrors = [err18];
                    } else {
                      vErrors.push(err18);
          ...
          if (data.command === void 0 && (missing3 = "command") || data.type === void 0 && (missing3 = "type")) {
            ...
            if (valid5) {
              if (data.type !== void 0) {
                ...
                if (!(data12 === "unknown")) {
                  const err23 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema42.oneOf[3].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err23];
                  } else {
                    vErrors.push(err23);
      ...
      if (data.diff === void 0 && (missing0 = "diff") || data.kind === void 0 && (missing0 = "kind") || data.path === void 0 && (missing0 = "path")) {
        ...
        if (data.diff !== void 0) {
          ...
          if (typeof data.diff !== "string") {
            validate38.errors = [{ instancePath: instancePath + "/diff", schemaPath: "#/properties/diff/type", keyword: "type", params: { type: "string" } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
              ...
              if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                ...
                if (data1.type === void 0 && (missing1 = "type")) {
                  ...
                  if (data1.type !== void 0) {
                    ...
                    if (!(data2 === "add")) {
                      const err2 = { instancePath: instancePath + "/kind/type", schemaPath: "#/definitions/v2/PatchChangeKind/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema48.oneOf[0].properties.type.enum } };
                      if (vErrors === null) {
                        vErrors = [err2];
                      } else {
                        vErrors.push(err2);
              ...
              if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
                ...
                if (data1.type === void 0 && (missing2 = "type")) {
                  ...
                  if (data1.type !== void 0) {
                    ...
                    if (!(data3 === "delete")) {
                      const err6 = { instancePath: instancePath + "/kind/type", schemaPath: "#/definitions/v2/PatchChangeKind/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema48.oneOf[1].properties.type.enum } };
                      if (vErrors === null) {
                        vErrors = [err6];
                      } else {
                        vErrors.push(err6);
                  ...
                  if (data1.type === void 0 && (missing3 = "type")) {
                    ...
                    if (data1.move_path !== void 0) {
                      ...
                      if (typeof data4 !== "string" && data4 !== null) {
                        const err9 = { instancePath: instancePath + "/kind/move_path", schemaPath: "#/definitions/v2/PatchChangeKind/oneOf/2/properties/move_path/type", keyword: "type", params: { type: schema48.oneOf[2].properties.move_path.type } };
                        if (vErrors === null) {
                          vErrors = [err9];
                        } else {
                          vErrors.push(err9);
                    ...
                    if (valid5) {
                      if (data1.type !== void 0) {
                        ...
                        if (!(data5 === "update")) {
                          const err11 = { instancePath: instancePath + "/kind/type", schemaPath: "#/definitions/v2/PatchChangeKind/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema48.oneOf[2].properties.type.enum } };
                          if (vErrors === null) {
                            vErrors = [err11];
                          } else {
                            vErrors.push(err11);
          ...
          if (valid0) {
            if (data.path !== void 0) {
              const _errs20 = errors;
              if (typeof data.path !== "string") {
                validate38.errors = [{ instancePath: instancePath + "/path", schemaPath: "#/properties/path/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.status === void 0 && (missing0 = "status")) {
        ...
        if (data.message !== void 0) {
          ...
          const _errs1 = errors;
          if (typeof data0 !== "string" && data0 !== null) {
            validate40.errors = [{ instancePath: instancePath + "/message", schemaPath: "#/properties/message/type", keyword: "type", params: { type: schema56.properties.message.type } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          if (data.status !== void 0) {
            ...
            const _errs3 = errors;
            if (typeof data1 !== "string") {
              validate40.errors = [{ instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CollabAgentStatus/type", keyword: "type", params: { type: "string" } }];
              return false;
            }
            if (!(data1 === "pendingInit" || data1 === "running" || data1 === "interrupted" || data1 === "completed" || data1 === "errored" || data1 === "shutdown" || data1 === "notFound")) {
              validate40.errors = [{ instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CollabAgentStatus/enum", keyword: "enum", params: { allowedValues: schema57.enum } }];
              return false;
            }
            var valid0 = _errs3 === errors;
          } else {
...
function validate29(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.content === void 0 && (missing0 = "content") || data.id === void 0 && (missing0 = "id") || data.type === void 0 && (missing0 = "type")) {
        ...
        if (data.clientId !== void 0) {
          ...
          const _errs3 = errors;
          if (typeof data0 !== "string" && data0 !== null) {
            const err1 = { instancePath: instancePath + "/clientId", schemaPath: "#/oneOf/0/properties/clientId/type", keyword: "type", params: { type: schema32.oneOf[0].properties.clientId.type } };
            if (vErrors === null) {
              vErrors = [err1];
            } else {
              vErrors.push(err1);
            ...
            if (valid1) {
              if (data.type !== void 0) {
                ...
                if (!(data4 === "userMessage")) {
                  const err5 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[0].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err5];
                  } else {
                    vErrors.push(err5);
          ...
          if (valid3) {
            if (data.type !== void 0) {
              ...
              if (!(data10 === "hookPrompt")) {
                const err15 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[1].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err15];
                } else {
                  vErrors.push(err15);
            ...
            if (valid7) {
              if (data.phase !== void 0) {
                ...
                if (!(data13 === "commentary")) {
                  const err22 = { instancePath: instancePath + "/phase", schemaPath: "#/definitions/v2/MessagePhase/oneOf/0/enum", keyword: "enum", params: { allowedValues: schema41.oneOf[0].enum } };
                  if (vErrors === null) {
                    vErrors = [err22];
                  } else {
                    vErrors.push(err22);
                ...
                if (!(data13 === "final_answer")) {
                  const err24 = { instancePath: instancePath + "/phase", schemaPath: "#/definitions/v2/MessagePhase/oneOf/1/enum", keyword: "enum", params: { allowedValues: schema41.oneOf[1].enum } };
                  if (vErrors === null) {
                    vErrors = [err24];
                  } else {
                    vErrors.push(err24);
                ...
                if (valid7) {
                  if (data.type !== void 0) {
                    ...
                    if (!(data15 === "agentMessage")) {
                      const err30 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[2].properties.type.enum } };
                      if (vErrors === null) {
                        vErrors = [err30];
                      } else {
                        vErrors.push(err30);
            ...
            if (valid12) {
              ...
              if (valid12) {
                if (data.type !== void 0) {
                  ...
                  if (!(data18 === "plan")) {
                    const err36 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[3].properties.type.enum } };
                    if (vErrors === null) {
                      vErrors = [err36];
                    } else {
                      vErrors.push(err36);
                ...
                if (valid13) {
                  ...
                  if (valid13) {
                    if (data.type !== void 0) {
                      ...
                      if (!(data24 === "reasoning")) {
                        const err45 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/4/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[4].properties.type.enum } };
                        if (vErrors === null) {
                          vErrors = [err45];
                        } else {
                          vErrors.push(err45);
        ...
        if (_valid0 && valid0) {
          ...
          if (errors === _errs73) {
            if (data && typeof data == "object" && !Array.isArray(data)) {
              ...
              if (data.command === void 0 && (missing6 = "command") || data.commandActions === void 0 && (missing6 = "commandActions") || data.cwd === void 0 && (missing6 = "cwd") || data.id === void 0 && (missing6 = "id") || data.status === void 0 && (missing6 = "status") || data.type === void 0 && (missing6 = "type")) {
                ...
                if (data.aggregatedOutput !== void 0) {
                  ...
                  if (typeof data25 !== "string" && data25 !== null) {
                    const err48 = { instancePath: instancePath + "/aggregatedOutput", schemaPath: "#/oneOf/5/properties/aggregatedOutput/type", keyword: "type", params: { type: schema32.oneOf[5].properties.aggregatedOutput.type } };
                    if (vErrors === null) {
                      vErrors = [err48];
                    } else {
                      vErrors.push(err48);
                      ...
                      if (valid16) {
                        if (data.durationMs !== void 0) {
                          ...
                          if (!(typeof data30 == "number" && (!(data30 % 1) && !isNaN(data30)) && isFinite(data30)) && data30 !== null) {
                            const err52 = { instancePath: instancePath + "/durationMs", schemaPath: "#/oneOf/5/properties/durationMs/type", keyword: "type", params: { type: schema32.oneOf[5].properties.durationMs.type } };
                            if (vErrors === null) {
                              vErrors = [err52];
                            } else {
                              vErrors.push(err52);
                        ...
                        if (valid16) {
                          if (data.exitCode !== void 0) {
                            ...
                            if (!(typeof data31 == "number" && (!(data31 % 1) && !isNaN(data31)) && isFinite(data31)) && data31 !== null) {
                              const err53 = { instancePath: instancePath + "/exitCode", schemaPath: "#/oneOf/5/properties/exitCode/type", keyword: "type", params: { type: schema32.oneOf[5].properties.exitCode.type } };
                              if (vErrors === null) {
                                vErrors = [err53];
                              } else {
                                vErrors.push(err53);
                            ...
                            if (valid16) {
                              if (data.processId !== void 0) {
                                ...
                                if (typeof data33 !== "string" && data33 !== null) {
                                  const err55 = { instancePath: instancePath + "/processId", schemaPath: "#/oneOf/5/properties/processId/type", keyword: "type", params: { type: schema32.oneOf[5].properties.processId.type } };
                                  if (vErrors === null) {
                                    vErrors = [err55];
                                  } else {
                                    vErrors.push(err55);
                              ...
                              if (valid16) {
                                if (data.source !== void 0) {
                                  ...
                                  if (typeof data34 !== "string") {
                                    const err56 = { instancePath: instancePath + "/source", schemaPath: "#/definitions/v2/CommandExecutionSource/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err56];
                                    } else {
                                      vErrors.push(err56);
                                  ...
                                  if (!(data34 === "agent" || data34 === "userShell" || data34 === "unifiedExecStartup" || data34 === "unifiedExecInteraction")) {
                                    const err57 = { instancePath: instancePath + "/source", schemaPath: "#/definitions/v2/CommandExecutionSource/enum", keyword: "enum", params: { allowedValues: schema45.enum } };
                                    if (vErrors === null) {
                                      vErrors = [err57];
                                    } else {
                                      vErrors.push(err57);
                                ...
                                if (valid16) {
                                  if (data.status !== void 0) {
                                    ...
                                    if (typeof data35 !== "string") {
                                      const err58 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CommandExecutionStatus/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err58];
                                      } else {
                                        vErrors.push(err58);
                                    ...
                                    if (!(data35 === "inProgress" || data35 === "completed" || data35 === "failed" || data35 === "declined")) {
                                      const err59 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CommandExecutionStatus/enum", keyword: "enum", params: { allowedValues: schema46.enum } };
                                      if (vErrors === null) {
                                        vErrors = [err59];
                                      } else {
                                        vErrors.push(err59);
                                  ...
                                  if (valid16) {
                                    if (data.type !== void 0) {
                                      ...
                                      if (typeof data36 !== "string") {
                                        const err60 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/5/properties/type/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err60];
                                        } else {
                                          vErrors.push(err60);
                                      ...
                                      if (!(data36 === "commandExecution")) {
                                        const err61 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/5/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[5].properties.type.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err61];
                                        } else {
                                          vErrors.push(err61);
              ...
              const err62 = { instancePath, schemaPath: "#/oneOf/5/type", keyword: "type", params: { type: "object" } };
              if (vErrors === null) {
                vErrors = [err62];
              } else {
                vErrors.push(err62);
            ...
            if (errors === _errs103) {
              if (data && typeof data == "object" && !Array.isArray(data)) {
                ...
                if (data.changes === void 0 && (missing7 = "changes") || data.id === void 0 && (missing7 = "id") || data.status === void 0 && (missing7 = "status") || data.type === void 0 && (missing7 = "type")) {
                  const err63 = { instancePath, schemaPath: "#/oneOf/6/required", keyword: "required", params: { missingProperty: missing7 } };
                  if (vErrors === null) {
                    vErrors = [err63];
                  } else {
                    vErrors.push(err63);
                  ...
                  if (data.changes !== void 0) {
                    ...
                    if (errors === _errs105) {
                      if (Array.isArray(data37)) {
                        ...
                        const err64 = { instancePath: instancePath + "/changes", schemaPath: "#/oneOf/6/properties/changes/type", keyword: "type", params: { type: "array" } };
                        if (vErrors === null) {
                          vErrors = [err64];
                        } else {
                          vErrors.push(err64);
                    ...
                    if (valid23) {
                      if (data.status !== void 0) {
                        ...
                        if (typeof data40 !== "string") {
                          const err66 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/PatchApplyStatus/type", keyword: "type", params: { type: "string" } };
                          if (vErrors === null) {
                            vErrors = [err66];
                          } else {
                            vErrors.push(err66);
                        ...
                        if (!(data40 === "inProgress" || data40 === "completed" || data40 === "failed" || data40 === "declined")) {
                          const err67 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/PatchApplyStatus/enum", keyword: "enum", params: { allowedValues: schema49.enum } };
                          if (vErrors === null) {
                            vErrors = [err67];
                          } else {
                            vErrors.push(err67);
                      ...
                      if (valid23) {
                        if (data.type !== void 0) {
                          ...
                          if (typeof data41 !== "string") {
                            const err68 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/6/properties/type/type", keyword: "type", params: { type: "string" } };
                            if (vErrors === null) {
                              vErrors = [err68];
                            } else {
                              vErrors.push(err68);
                          ...
                          if (!(data41 === "fileChange")) {
                            const err69 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/6/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[6].properties.type.enum } };
                            if (vErrors === null) {
                              vErrors = [err69];
                            } else {
                              vErrors.push(err69);
                ...
                const err70 = { instancePath, schemaPath: "#/oneOf/6/type", keyword: "type", params: { type: "object" } };
                if (vErrors === null) {
                  vErrors = [err70];
                } else {
                  vErrors.push(err70);
              ...
              if (errors === _errs115) {
                if (data && typeof data == "object" && !Array.isArray(data)) {
                  ...
                  if (data.arguments === void 0 && (missing8 = "arguments") || data.id === void 0 && (missing8 = "id") || data.server === void 0 && (missing8 = "server") || data.status === void 0 && (missing8 = "status") || data.tool === void 0 && (missing8 = "tool") || data.type === void 0 && (missing8 = "type")) {
                    const err71 = { instancePath, schemaPath: "#/oneOf/7/required", keyword: "required", params: { missingProperty: missing8 } };
                    if (vErrors === null) {
                      vErrors = [err71];
                    } else {
                      vErrors.push(err71);
                    ...
                    if (data.appContext !== void 0) {
                      ...
                      if (errors === _errs120) {
                        if (data42 && typeof data42 == "object" && !Array.isArray(data42)) {
                          ...
                          if (data42.connectorId === void 0 && (missing9 = "connectorId")) {
                            const err72 = { instancePath: instancePath + "/appContext", schemaPath: "#/definitions/v2/McpToolCallAppContext/required", keyword: "required", params: { missingProperty: missing9 } };
                            if (vErrors === null) {
                              vErrors = [err72];
                            } else {
                              vErrors.push(err72);
                            ...
                            if (data42.actionName !== void 0) {
                              ...
                              if (typeof data43 !== "string" && data43 !== null) {
                                const err73 = { instancePath: instancePath + "/appContext/actionName", schemaPath: "#/definitions/v2/McpToolCallAppContext/properties/actionName/type", keyword: "type", params: { type: schema50.properties.actionName.type } };
                                if (vErrors === null) {
                                  vErrors = [err73];
                                } else {
                                  vErrors.push(err73);
                            ...
                            if (valid29) {
                              if (data42.appName !== void 0) {
                                ...
                                if (typeof data44 !== "string" && data44 !== null) {
                                  const err74 = { instancePath: instancePath + "/appContext/appName", schemaPath: "#/definitions/v2/McpToolCallAppContext/properties/appName/type", keyword: "type", params: { type: schema50.properties.appName.type } };
                                  if (vErrors === null) {
                                    vErrors = [err74];
                                  } else {
                                    vErrors.push(err74);
                              ...
                              if (valid29) {
                                if (data42.connectorId !== void 0) {
                                  ...
                                  if (typeof data42.connectorId !== "string") {
                                    const err75 = { instancePath: instancePath + "/appContext/connectorId", schemaPath: "#/definitions/v2/McpToolCallAppContext/properties/connectorId/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err75];
                                    } else {
                                      vErrors.push(err75);
                                ...
                                if (valid29) {
                                  if (data42.linkId !== void 0) {
                                    ...
                                    if (typeof data46 !== "string" && data46 !== null) {
                                      const err76 = { instancePath: instancePath + "/appContext/linkId", schemaPath: "#/definitions/v2/McpToolCallAppContext/properties/linkId/type", keyword: "type", params: { type: schema50.properties.linkId.type } };
                                      if (vErrors === null) {
                                        vErrors = [err76];
                                      } else {
                                        vErrors.push(err76);
                                  ...
                                  if (valid29) {
                                    if (data42.resourceUri !== void 0) {
                                      ...
                                      if (typeof data47 !== "string" && data47 !== null) {
                                        const err77 = { instancePath: instancePath + "/appContext/resourceUri", schemaPath: "#/definitions/v2/McpToolCallAppContext/properties/resourceUri/type", keyword: "type", params: { type: schema50.properties.resourceUri.type } };
                                        if (vErrors === null) {
                                          vErrors = [err77];
                                        } else {
                                          vErrors.push(err77);
                          ...
                          const err78 = { instancePath: instancePath + "/appContext", schemaPath: "#/definitions/v2/McpToolCallAppContext/type", keyword: "type", params: { type: "object" } };
                          if (vErrors === null) {
                            vErrors = [err78];
                          } else {
                            vErrors.push(err78);
                      ...
                      if (!valid27) {
                        ...
                        if (data42 !== null) {
                          const err79 = { instancePath: instancePath + "/appContext", schemaPath: "#/oneOf/7/properties/appContext/anyOf/1/type", keyword: "type", params: { type: "null" } };
                          if (vErrors === null) {
                            vErrors = [err79];
                          } else {
                            vErrors.push(err79);
                      ...
                      if (!valid27) {
                        const err80 = { instancePath: instancePath + "/appContext", schemaPath: "#/oneOf/7/properties/appContext/anyOf", keyword: "anyOf", params: {} };
                        if (vErrors === null) {
                          vErrors = [err80];
                        } else {
                          vErrors.push(err80);
                    ...
                    if (valid26) {
                      if (data.durationMs !== void 0) {
                        let data48 = data.durationMs;
                        const _errs134 = errors;
                        if (!(typeof data48 == "number" && (!(data48 % 1) && !isNaN(data48)) && isFinite(data48)) && data48 !== null) {
                          const err81 = { instancePath: instancePath + "/durationMs", schemaPath: "#/oneOf/7/properties/durationMs/type", keyword: "type", params: { type: schema32.oneOf[7].properties.durationMs.type } };
                          if (vErrors === null) {
                            vErrors = [err81];
                          } else {
                            vErrors.push(err81);
                        ...
                        var valid26 = _errs134 === errors;
                      } else {
                        var valid26 = true;
                      }
                      if (valid26) {
                        if (data.error !== void 0) {
                          let data49 = data.error;
                          ...
                          if (errors === _errs139) {
                            if (data49 && typeof data49 == "object" && !Array.isArray(data49)) {
                              let missing10;
                              if (data49.message === void 0 && (missing10 = "message")) {
                                const err82 = { instancePath: instancePath + "/error", schemaPath: "#/definitions/v2/McpToolCallError/required", keyword: "required", params: { missingProperty: missing10 } };
                                if (vErrors === null) {
                                  vErrors = [err82];
                                } else {
                                  vErrors.push(err82);
                                ...
                                if (data49.message !== void 0) {
                                  if (typeof data49.message !== "string") {
                                    const err83 = { instancePath: instancePath + "/error/message", schemaPath: "#/definitions/v2/McpToolCallError/properties/message/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err83];
                                    } else {
                                      vErrors.push(err83);
                              ...
                              const err84 = { instancePath: instancePath + "/error", schemaPath: "#/definitions/v2/McpToolCallError/type", keyword: "type", params: { type: "object" } };
                              if (vErrors === null) {
                                vErrors = [err84];
                              } else {
                                vErrors.push(err84);
                          ...
                          if (!valid30) {
                            ...
                            if (data49 !== null) {
                              const err85 = { instancePath: instancePath + "/error", schemaPath: "#/oneOf/7/properties/error/anyOf/1/type", keyword: "type", params: { type: "null" } };
                              if (vErrors === null) {
                                vErrors = [err85];
                              } else {
                                vErrors.push(err85);
                          ...
                          if (!valid30) {
                            const err86 = { instancePath: instancePath + "/error", schemaPath: "#/oneOf/7/properties/error/anyOf", keyword: "anyOf", params: {} };
                            if (vErrors === null) {
                              vErrors = [err86];
                            } else {
                              vErrors.push(err86);
                        ...
                        if (valid26) {
                          if (data.id !== void 0) {
                            ...
                            if (typeof data.id !== "string") {
                              const err87 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/7/properties/id/type", keyword: "type", params: { type: "string" } };
                              if (vErrors === null) {
                                vErrors = [err87];
                              } else {
                                vErrors.push(err87);
                            ...
                            var valid26 = _errs145 === errors;
                          } else {
                            var valid26 = true;
                          }
                          if (valid26) {
                            if (data.mcpAppResourceUri !== void 0) {
                              let data52 = data.mcpAppResourceUri;
                              const _errs147 = errors;
                              if (typeof data52 !== "string" && data52 !== null) {
                                const err88 = { instancePath: instancePath + "/mcpAppResourceUri", schemaPath: "#/oneOf/7/properties/mcpAppResourceUri/type", keyword: "type", params: { type: schema32.oneOf[7].properties.mcpAppResourceUri.type } };
                                if (vErrors === null) {
                                  vErrors = [err88];
                                } else {
                                  vErrors.push(err88);
                            ...
                            if (valid26) {
                              if (data.pluginId !== void 0) {
                                let data53 = data.pluginId;
                                const _errs149 = errors;
                                if (typeof data53 !== "string" && data53 !== null) {
                                  const err89 = { instancePath: instancePath + "/pluginId", schemaPath: "#/oneOf/7/properties/pluginId/type", keyword: "type", params: { type: schema32.oneOf[7].properties.pluginId.type } };
                                  if (vErrors === null) {
                                    vErrors = [err89];
                                  } else {
                                    vErrors.push(err89);
                                ...
                                if (data.result !== void 0) {
                                  ...
                                  if (errors === _errs154) {
                                    if (data54 && typeof data54 == "object" && !Array.isArray(data54)) {
                                      let missing11;
                                      if (data54.content === void 0 && (missing11 = "content")) {
                                        const err90 = { instancePath: instancePath + "/result", schemaPath: "#/definitions/v2/McpToolCallResult/required", keyword: "required", params: { missingProperty: missing11 } };
                                        if (vErrors === null) {
                                          vErrors = [err90];
                                        } else {
                                          vErrors.push(err90);
                                        ...
                                        if (data54.content !== void 0) {
                                          const _errs156 = errors;
                                          if (errors === _errs156) {
                                            if (!Array.isArray(data54.content)) {
                                              const err91 = { instancePath: instancePath + "/result/content", schemaPath: "#/definitions/v2/McpToolCallResult/properties/content/type", keyword: "type", params: { type: "array" } };
                                              if (vErrors === null) {
                                                vErrors = [err91];
                                              } else {
                                                vErrors.push(err91);
                                      ...
                                      const err92 = { instancePath: instancePath + "/result", schemaPath: "#/definitions/v2/McpToolCallResult/type", keyword: "type", params: { type: "object" } };
                                      if (vErrors === null) {
                                        vErrors = [err92];
                                      } else {
                                        vErrors.push(err92);
                                  ...
                                  if (!valid33) {
                                    ...
                                    if (data54 !== null) {
                                      const err93 = { instancePath: instancePath + "/result", schemaPath: "#/oneOf/7/properties/result/anyOf/1/type", keyword: "type", params: { type: "null" } };
                                      if (vErrors === null) {
                                        vErrors = [err93];
                                      } else {
                                        vErrors.push(err93);
                                  ...
                                  if (!valid33) {
                                    const err94 = { instancePath: instancePath + "/result", schemaPath: "#/oneOf/7/properties/result/anyOf", keyword: "anyOf", params: {} };
                                    if (vErrors === null) {
                                      vErrors = [err94];
                                    } else {
                                      vErrors.push(err94);
                                ...
                                if (valid26) {
                                  if (data.server !== void 0) {
                                    ...
                                    if (typeof data.server !== "string") {
                                      const err95 = { instancePath: instancePath + "/server", schemaPath: "#/oneOf/7/properties/server/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err95];
                                      } else {
                                        vErrors.push(err95);
                                  ...
                                  if (valid26) {
                                    if (data.status !== void 0) {
                                      ...
                                      if (typeof data57 !== "string") {
                                        const err96 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/McpToolCallStatus/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err96];
                                        } else {
                                          vErrors.push(err96);
                                      ...
                                      if (!(data57 === "inProgress" || data57 === "completed" || data57 === "failed")) {
                                        const err97 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/McpToolCallStatus/enum", keyword: "enum", params: { allowedValues: schema53.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err97];
                                        } else {
                                          vErrors.push(err97);
                                    ...
                                    if (valid26) {
                                      if (data.tool !== void 0) {
                                        ...
                                        if (typeof data.tool !== "string") {
                                          const err98 = { instancePath: instancePath + "/tool", schemaPath: "#/oneOf/7/properties/tool/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err98];
                                          } else {
                                            vErrors.push(err98);
                                      ...
                                      if (valid26) {
                                        if (data.type !== void 0) {
                                          ...
                                          if (typeof data59 !== "string") {
                                            const err99 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/7/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err99];
                                            } else {
                                              vErrors.push(err99);
                                          ...
                                          if (!(data59 === "mcpToolCall")) {
                                            const err100 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/7/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[7].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err100];
                                            } else {
                                              vErrors.push(err100);
                  ...
                  const err101 = { instancePath, schemaPath: "#/oneOf/7/type", keyword: "type", params: { type: "object" } };
                  if (vErrors === null) {
                    vErrors = [err101];
                  } else {
                    vErrors.push(err101);
                ...
                if (errors === _errs169) {
                  if (data && typeof data == "object" && !Array.isArray(data)) {
                    ...
                    if (data.arguments === void 0 && (missing12 = "arguments") || data.id === void 0 && (missing12 = "id") || data.status === void 0 && (missing12 = "status") || data.tool === void 0 && (missing12 = "tool") || data.type === void 0 && (missing12 = "type")) {
                      const err102 = { instancePath, schemaPath: "#/oneOf/8/required", keyword: "required", params: { missingProperty: missing12 } };
                      if (vErrors === null) {
                        vErrors = [err102];
                      } else {
                        vErrors.push(err102);
                      ...
                      if (data.contentItems !== void 0) {
                        let data60 = data.contentItems;
                        const _errs171 = errors;
                        if (!Array.isArray(data60) && data60 !== null) {
                          const err103 = { instancePath: instancePath + "/contentItems", schemaPath: "#/oneOf/8/properties/contentItems/type", keyword: "type", params: { type: schema32.oneOf[8].properties.contentItems.type } };
                          if (vErrors === null) {
                            vErrors = [err103];
                          } else {
                            vErrors.push(err103);
                            ...
                            for (let i6 = 0; i6 < len6; i6++) {
                              ...
                              if (errors === _errs176) {
                                if (data61 && typeof data61 == "object" && !Array.isArray(data61)) {
                                  let missing13;
                                  if (data61.text === void 0 && (missing13 = "text") || data61.type === void 0 && (missing13 = "type")) {
                                    const err104 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/0/required", keyword: "required", params: { missingProperty: missing13 } };
                                    if (vErrors === null) {
                                      vErrors = [err104];
                                    } else {
                                      vErrors.push(err104);
                                    ...
                                    if (data61.text !== void 0) {
                                      ...
                                      if (typeof data61.text !== "string") {
                                        const err105 = { instancePath: instancePath + "/contentItems/" + i6 + "/text", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/0/properties/text/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err105];
                                        } else {
                                          vErrors.push(err105);
                                      ...
                                      var valid41 = _errs178 === errors;
                                    } else {
                                      var valid41 = true;
                                    }
                                    if (valid41) {
                                      if (data61.type !== void 0) {
                                        let data63 = data61.type;
                                        const _errs180 = errors;
                                        if (typeof data63 !== "string") {
                                          const err106 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/0/properties/type/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err106];
                                          } else {
                                            vErrors.push(err106);
                                        ...
                                        if (!(data63 === "inputText")) {
                                          const err107 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema54.oneOf[0].properties.type.enum } };
                                          if (vErrors === null) {
                                            vErrors = [err107];
                                          } else {
                                            vErrors.push(err107);
                                  ...
                                  const err108 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/0/type", keyword: "type", params: { type: "object" } };
                                  if (vErrors === null) {
                                    vErrors = [err108];
                                  } else {
                                    vErrors.push(err108);
                              ...
                              if (errors === _errs182) {
                                if (data61 && typeof data61 == "object" && !Array.isArray(data61)) {
                                  let missing14;
                                  if (data61.imageUrl === void 0 && (missing14 = "imageUrl") || data61.type === void 0 && (missing14 = "type")) {
                                    const err109 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/1/required", keyword: "required", params: { missingProperty: missing14 } };
                                    if (vErrors === null) {
                                      vErrors = [err109];
                                    } else {
                                      vErrors.push(err109);
                                    ...
                                    if (data61.imageUrl !== void 0) {
                                      const _errs184 = errors;
                                      if (typeof data61.imageUrl !== "string") {
                                        const err110 = { instancePath: instancePath + "/contentItems/" + i6 + "/imageUrl", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/1/properties/imageUrl/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err110];
                                        } else {
                                          vErrors.push(err110);
                                    ...
                                    if (valid42) {
                                      if (data61.type !== void 0) {
                                        ...
                                        if (typeof data65 !== "string") {
                                          const err111 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/1/properties/type/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err111];
                                          } else {
                                            vErrors.push(err111);
                                        ...
                                        if (!(data65 === "inputImage")) {
                                          const err112 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema54.oneOf[1].properties.type.enum } };
                                          if (vErrors === null) {
                                            vErrors = [err112];
                                          } else {
                                            vErrors.push(err112);
                                  ...
                                  const err113 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/1/type", keyword: "type", params: { type: "object" } };
                                  if (vErrors === null) {
                                    vErrors = [err113];
                                  } else {
                                    vErrors.push(err113);
                              ...
                              if (_valid7 && valid40) {
                                ...
                                if (errors === _errs188) {
                                  if (data61 && typeof data61 == "object" && !Array.isArray(data61)) {
                                    let missing15;
                                    if (data61.audioUrl === void 0 && (missing15 = "audioUrl") || data61.type === void 0 && (missing15 = "type")) {
                                      const err114 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/2/required", keyword: "required", params: { missingProperty: missing15 } };
                                      if (vErrors === null) {
                                        vErrors = [err114];
                                      } else {
                                        vErrors.push(err114);
                                      ...
                                      if (data61.audioUrl !== void 0) {
                                        const _errs190 = errors;
                                        if (typeof data61.audioUrl !== "string") {
                                          const err115 = { instancePath: instancePath + "/contentItems/" + i6 + "/audioUrl", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/2/properties/audioUrl/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err115];
                                          } else {
                                            vErrors.push(err115);
                                        ...
                                        var valid43 = _errs190 === errors;
                                      } else {
                                        var valid43 = true;
                                      }
                                      if (valid43) {
                                        if (data61.type !== void 0) {
                                          let data67 = data61.type;
                                          const _errs192 = errors;
                                          if (typeof data67 !== "string") {
                                            const err116 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/2/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err116];
                                            } else {
                                              vErrors.push(err116);
                                          ...
                                          if (!(data67 === "inputAudio")) {
                                            const err117 = { instancePath: instancePath + "/contentItems/" + i6 + "/type", schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema54.oneOf[2].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err117];
                                            } else {
                                              vErrors.push(err117);
                                    ...
                                    const err118 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf/2/type", keyword: "type", params: { type: "object" } };
                                    if (vErrors === null) {
                                      vErrors = [err118];
                                    } else {
                                      vErrors.push(err118);
                              ...
                              if (!valid40) {
                                const err119 = { instancePath: instancePath + "/contentItems/" + i6, schemaPath: "#/definitions/v2/DynamicToolCallOutputContentItem/oneOf", keyword: "oneOf", params: { passingSchemas: passing2 } };
                                if (vErrors === null) {
                                  vErrors = [err119];
                                } else {
                                  vErrors.push(err119);
                        ...
                        var valid37 = _errs171 === errors;
                      } else {
                        var valid37 = true;
                      }
                      if (valid37) {
                        if (data.durationMs !== void 0) {
                          let data68 = data.durationMs;
                          const _errs194 = errors;
                          if (!(typeof data68 == "number" && (!(data68 % 1) && !isNaN(data68)) && isFinite(data68)) && data68 !== null) {
                            const err120 = { instancePath: instancePath + "/durationMs", schemaPath: "#/oneOf/8/properties/durationMs/type", keyword: "type", params: { type: schema32.oneOf[8].properties.durationMs.type } };
                            if (vErrors === null) {
                              vErrors = [err120];
                            } else {
                              vErrors.push(err120);
                        ...
                        if (valid37) {
                          if (data.id !== void 0) {
                            ...
                            if (typeof data.id !== "string") {
                              const err121 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/8/properties/id/type", keyword: "type", params: { type: "string" } };
                              if (vErrors === null) {
                                vErrors = [err121];
                              } else {
                                vErrors.push(err121);
                          ...
                          if (valid37) {
                            if (data.namespace !== void 0) {
                              let data70 = data.namespace;
                              const _errs198 = errors;
                              if (typeof data70 !== "string" && data70 !== null) {
                                const err122 = { instancePath: instancePath + "/namespace", schemaPath: "#/oneOf/8/properties/namespace/type", keyword: "type", params: { type: schema32.oneOf[8].properties.namespace.type } };
                                if (vErrors === null) {
                                  vErrors = [err122];
                                } else {
                                  vErrors.push(err122);
                            ...
                            if (valid37) {
                              if (data.status !== void 0) {
                                ...
                                if (typeof data71 !== "string") {
                                  const err123 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/DynamicToolCallStatus/type", keyword: "type", params: { type: "string" } };
                                  if (vErrors === null) {
                                    vErrors = [err123];
                                  } else {
                                    vErrors.push(err123);
                                ...
                                if (!(data71 === "inProgress" || data71 === "completed" || data71 === "failed")) {
                                  const err124 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/DynamicToolCallStatus/enum", keyword: "enum", params: { allowedValues: schema55.enum } };
                                  if (vErrors === null) {
                                    vErrors = [err124];
                                  } else {
                                    vErrors.push(err124);
                              ...
                              if (valid37) {
                                if (data.success !== void 0) {
                                  let data72 = data.success;
                                  const _errs203 = errors;
                                  if (typeof data72 !== "boolean" && data72 !== null) {
                                    const err125 = { instancePath: instancePath + "/success", schemaPath: "#/oneOf/8/properties/success/type", keyword: "type", params: { type: schema32.oneOf[8].properties.success.type } };
                                    if (vErrors === null) {
                                      vErrors = [err125];
                                    } else {
                                      vErrors.push(err125);
                                ...
                                if (valid37) {
                                  if (data.tool !== void 0) {
                                    ...
                                    if (typeof data.tool !== "string") {
                                      const err126 = { instancePath: instancePath + "/tool", schemaPath: "#/oneOf/8/properties/tool/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err126];
                                      } else {
                                        vErrors.push(err126);
                                  ...
                                  if (valid37) {
                                    if (data.type !== void 0) {
                                      ...
                                      if (typeof data74 !== "string") {
                                        const err127 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/8/properties/type/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err127];
                                        } else {
                                          vErrors.push(err127);
                                      ...
                                      if (!(data74 === "dynamicToolCall")) {
                                        const err128 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/8/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[8].properties.type.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err128];
                                        } else {
                                          vErrors.push(err128);
                    ...
                    const err129 = { instancePath, schemaPath: "#/oneOf/8/type", keyword: "type", params: { type: "object" } };
                    if (vErrors === null) {
                      vErrors = [err129];
                    } else {
                      vErrors.push(err129);
                  ...
                  if (errors === _errs209) {
                    if (data && typeof data == "object" && !Array.isArray(data)) {
                      ...
                      if (data.agentsStates === void 0 && (missing16 = "agentsStates") || data.id === void 0 && (missing16 = "id") || data.receiverThreadIds === void 0 && (missing16 = "receiverThreadIds") || data.senderThreadId === void 0 && (missing16 = "senderThreadId") || data.status === void 0 && (missing16 = "status") || data.tool === void 0 && (missing16 = "tool") || data.type === void 0 && (missing16 = "type")) {
                        const err130 = { instancePath, schemaPath: "#/oneOf/9/required", keyword: "required", params: { missingProperty: missing16 } };
                        if (vErrors === null) {
                          vErrors = [err130];
                        } else {
                          vErrors.push(err130);
                        ...
                        if (data.agentsStates !== void 0) {
                          let data75 = data.agentsStates;
                          const _errs211 = errors;
                          if (errors === _errs211) {
                            if (data75 && typeof data75 == "object" && !Array.isArray(data75)) {
                              for (const key0 in data75) {
                                const _errs214 = errors;
                                if (!validate40(data75[key0], { instancePath: instancePath + "/agentsStates/" + key0.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data75, parentDataProperty: key0, rootData })) {
                              ...
                              const err131 = { instancePath: instancePath + "/agentsStates", schemaPath: "#/oneOf/9/properties/agentsStates/type", keyword: "type", params: { type: "object" } };
                              if (vErrors === null) {
                                vErrors = [err131];
                              } else {
                                vErrors.push(err131);
                        ...
                        if (valid45) {
                          if (data.id !== void 0) {
                            ...
                            if (typeof data.id !== "string") {
                              const err132 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/9/properties/id/type", keyword: "type", params: { type: "string" } };
                              if (vErrors === null) {
                                vErrors = [err132];
                              } else {
                                vErrors.push(err132);
                          ...
                          if (valid45) {
                            if (data.model !== void 0) {
                              let data78 = data.model;
                              const _errs217 = errors;
                              if (typeof data78 !== "string" && data78 !== null) {
                                const err133 = { instancePath: instancePath + "/model", schemaPath: "#/oneOf/9/properties/model/type", keyword: "type", params: { type: schema32.oneOf[9].properties.model.type } };
                                if (vErrors === null) {
                                  vErrors = [err133];
                                } else {
                                  vErrors.push(err133);
                            ...
                            if (valid45) {
                              if (data.prompt !== void 0) {
                                let data79 = data.prompt;
                                const _errs219 = errors;
                                if (typeof data79 !== "string" && data79 !== null) {
                                  const err134 = { instancePath: instancePath + "/prompt", schemaPath: "#/oneOf/9/properties/prompt/type", keyword: "type", params: { type: schema32.oneOf[9].properties.prompt.type } };
                                  if (vErrors === null) {
                                    vErrors = [err134];
                                  } else {
                                    vErrors.push(err134);
                                ...
                                var valid45 = _errs219 === errors;
                              } else {
                                var valid45 = true;
                              }
                              if (valid45) {
                                if (data.reasoningEffort !== void 0) {
                                  let data80 = data.reasoningEffort;
                                  ...
                                  if (errors === _errs224) {
                                    if (typeof data80 === "string") {
                                      if (func2(data80) < 1) {
                                        const err135 = { instancePath: instancePath + "/reasoningEffort", schemaPath: "#/definitions/v2/ReasoningEffort/minLength", keyword: "minLength", params: { limit: 1 } };
                                        if (vErrors === null) {
                                          vErrors = [err135];
                                        } else {
                                          vErrors.push(err135);
                                      ...
                                      const err136 = { instancePath: instancePath + "/reasoningEffort", schemaPath: "#/definitions/v2/ReasoningEffort/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err136];
                                      } else {
                                        vErrors.push(err136);
                                  ...
                                  var _valid8 = _errs223 === errors;
                                  valid47 = valid47 || _valid8;
                                  if (!valid47) {
                                    const _errs226 = errors;
                                    if (data80 !== null) {
                                      const err137 = { instancePath: instancePath + "/reasoningEffort", schemaPath: "#/oneOf/9/properties/reasoningEffort/anyOf/1/type", keyword: "type", params: { type: "null" } };
                                      if (vErrors === null) {
                                        vErrors = [err137];
                                      } else {
                                        vErrors.push(err137);
                                    ...
                                    var _valid8 = _errs226 === errors;
                                    valid47 = valid47 || _valid8;
                                  }
                                  if (!valid47) {
                                    const err138 = { instancePath: instancePath + "/reasoningEffort", schemaPath: "#/oneOf/9/properties/reasoningEffort/anyOf", keyword: "anyOf", params: {} };
                                    if (vErrors === null) {
                                      vErrors = [err138];
                                    } else {
                                      vErrors.push(err138);
                                ...
                                if (valid45) {
                                  if (data.receiverThreadIds !== void 0) {
                                    let data81 = data.receiverThreadIds;
                                    ...
                                    if (errors === _errs228) {
                                      if (Array.isArray(data81)) {
                                        ...
                                        for (let i7 = 0; i7 < len7; i7++) {
                                          ...
                                          if (typeof data81[i7] !== "string") {
                                            const err139 = { instancePath: instancePath + "/receiverThreadIds/" + i7, schemaPath: "#/oneOf/9/properties/receiverThreadIds/items/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err139];
                                            } else {
                                              vErrors.push(err139);
                                          ...
                                          var valid49 = _errs230 === errors;
                                          if (!valid49) {
                                            break;
                                          }
                                        }
                                      } else {
                                        const err140 = { instancePath: instancePath + "/receiverThreadIds", schemaPath: "#/oneOf/9/properties/receiverThreadIds/type", keyword: "type", params: { type: "array" } };
                                        if (vErrors === null) {
                                          vErrors = [err140];
                                        } else {
                                          vErrors.push(err140);
                                  ...
                                  if (valid45) {
                                    if (data.senderThreadId !== void 0) {
                                      ...
                                      if (typeof data.senderThreadId !== "string") {
                                        const err141 = { instancePath: instancePath + "/senderThreadId", schemaPath: "#/oneOf/9/properties/senderThreadId/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err141];
                                        } else {
                                          vErrors.push(err141);
                                      ...
                                      var valid45 = _errs232 === errors;
                                    } else {
                                      var valid45 = true;
                                    }
                                    if (valid45) {
                                      if (data.status !== void 0) {
                                        let data84 = data.status;
                                        const _errs234 = errors;
                                        if (typeof data84 !== "string") {
                                          const err142 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CollabAgentToolCallStatus/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err142];
                                          } else {
                                            vErrors.push(err142);
                                        ...
                                        if (!(data84 === "inProgress" || data84 === "completed" || data84 === "failed")) {
                                          const err143 = { instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/CollabAgentToolCallStatus/enum", keyword: "enum", params: { allowedValues: schema59.enum } };
                                          if (vErrors === null) {
                                            vErrors = [err143];
                                          } else {
                                            vErrors.push(err143);
                                      ...
                                      if (valid45) {
                                        if (data.tool !== void 0) {
                                          let data85 = data.tool;
                                          const _errs238 = errors;
                                          if (typeof data85 !== "string") {
                                            const err144 = { instancePath: instancePath + "/tool", schemaPath: "#/definitions/v2/CollabAgentTool/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err144];
                                            } else {
                                              vErrors.push(err144);
                                          ...
                                          if (!(data85 === "spawnAgent" || data85 === "sendInput" || data85 === "resumeAgent" || data85 === "wait" || data85 === "closeAgent")) {
                                            const err145 = { instancePath: instancePath + "/tool", schemaPath: "#/definitions/v2/CollabAgentTool/enum", keyword: "enum", params: { allowedValues: schema60.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err145];
                                            } else {
                                              vErrors.push(err145);
                                        ...
                                        if (valid45) {
                                          if (data.type !== void 0) {
                                            ...
                                            if (typeof data86 !== "string") {
                                              const err146 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/9/properties/type/type", keyword: "type", params: { type: "string" } };
                                              if (vErrors === null) {
                                                vErrors = [err146];
                                              } else {
                                                vErrors.push(err146);
                                            ...
                                            if (!(data86 === "collabAgentToolCall")) {
                                              const err147 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/9/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[9].properties.type.enum } };
                                              if (vErrors === null) {
                                                vErrors = [err147];
                                              } else {
                                                vErrors.push(err147);
                      ...
                      const err148 = { instancePath, schemaPath: "#/oneOf/9/type", keyword: "type", params: { type: "object" } };
                      if (vErrors === null) {
                        vErrors = [err148];
                      } else {
                        vErrors.push(err148);
                    ...
                    if (errors === _errs244) {
                      if (data && typeof data == "object" && !Array.isArray(data)) {
                        ...
                        if (data.agentPath === void 0 && (missing17 = "agentPath") || data.agentThreadId === void 0 && (missing17 = "agentThreadId") || data.id === void 0 && (missing17 = "id") || data.kind === void 0 && (missing17 = "kind") || data.type === void 0 && (missing17 = "type")) {
                          const err149 = { instancePath, schemaPath: "#/oneOf/10/required", keyword: "required", params: { missingProperty: missing17 } };
                          if (vErrors === null) {
                            vErrors = [err149];
                          } else {
                            vErrors.push(err149);
                          ...
                          if (data.agentPath !== void 0) {
                            ...
                            if (typeof data.agentPath !== "string") {
                              const err150 = { instancePath: instancePath + "/agentPath", schemaPath: "#/oneOf/10/properties/agentPath/type", keyword: "type", params: { type: "string" } };
                              if (vErrors === null) {
                                vErrors = [err150];
                              } else {
                                vErrors.push(err150);
                          ...
                          if (valid54) {
                            if (data.agentThreadId !== void 0) {
                              ...
                              if (typeof data.agentThreadId !== "string") {
                                const err151 = { instancePath: instancePath + "/agentThreadId", schemaPath: "#/oneOf/10/properties/agentThreadId/type", keyword: "type", params: { type: "string" } };
                                if (vErrors === null) {
                                  vErrors = [err151];
                                } else {
                                  vErrors.push(err151);
                            ...
                            if (valid54) {
                              if (data.id !== void 0) {
                                ...
                                if (typeof data.id !== "string") {
                                  const err152 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/10/properties/id/type", keyword: "type", params: { type: "string" } };
                                  if (vErrors === null) {
                                    vErrors = [err152];
                                  } else {
                                    vErrors.push(err152);
                              ...
                              if (valid54) {
                                if (data.kind !== void 0) {
                                  ...
                                  if (typeof data90 !== "string") {
                                    const err153 = { instancePath: instancePath + "/kind", schemaPath: "#/definitions/v2/SubAgentActivityKind/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err153];
                                    } else {
                                      vErrors.push(err153);
                                  ...
                                  if (!(data90 === "started" || data90 === "interacted" || data90 === "interrupted")) {
                                    const err154 = { instancePath: instancePath + "/kind", schemaPath: "#/definitions/v2/SubAgentActivityKind/enum", keyword: "enum", params: { allowedValues: schema61.enum } };
                                    if (vErrors === null) {
                                      vErrors = [err154];
                                    } else {
                                      vErrors.push(err154);
                                ...
                                if (valid54) {
                                  if (data.type !== void 0) {
                                    ...
                                    if (typeof data91 !== "string") {
                                      const err155 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/10/properties/type/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err155];
                                      } else {
                                        vErrors.push(err155);
                                    ...
                                    if (!(data91 === "subAgentActivity")) {
                                      const err156 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/10/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[10].properties.type.enum } };
                                      if (vErrors === null) {
                                        vErrors = [err156];
                                      } else {
                                        vErrors.push(err156);
                        ...
                        const err157 = { instancePath, schemaPath: "#/oneOf/10/type", keyword: "type", params: { type: "object" } };
                        if (vErrors === null) {
                          vErrors = [err157];
                        } else {
                          vErrors.push(err157);
                      ...
                      if (errors === _errs257) {
                        if (data && typeof data == "object" && !Array.isArray(data)) {
                          ...
                          if (data.id === void 0 && (missing18 = "id") || data.query === void 0 && (missing18 = "query") || data.type === void 0 && (missing18 = "type")) {
                            const err158 = { instancePath, schemaPath: "#/oneOf/11/required", keyword: "required", params: { missingProperty: missing18 } };
                            if (vErrors === null) {
                              vErrors = [err158];
                            } else {
                              vErrors.push(err158);
                            ...
                            if (data.action !== void 0) {
                              ...
                              if (errors === _errs264) {
                                if (data92 && typeof data92 == "object" && !Array.isArray(data92)) {
                                  let missing19;
                                  if (data92.type === void 0 && (missing19 = "type")) {
                                    const err159 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/required", keyword: "required", params: { missingProperty: missing19 } };
                                    if (vErrors === null) {
                                      vErrors = [err159];
                                    } else {
                                      vErrors.push(err159);
                                    ...
                                    if (data92.queries !== void 0) {
                                      let data93 = data92.queries;
                                      const _errs266 = errors;
                                      if (!Array.isArray(data93) && data93 !== null) {
                                        const err160 = { instancePath: instancePath + "/action/queries", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/properties/queries/type", keyword: "type", params: { type: schema62.oneOf[0].properties.queries.type } };
                                        if (vErrors === null) {
                                          vErrors = [err160];
                                        } else {
                                          vErrors.push(err160);
                                      ...
                                      if (errors === _errs266) {
                                        if (Array.isArray(data93)) {
                                          ...
                                          for (let i8 = 0; i8 < len8; i8++) {
                                            ...
                                            if (typeof data93[i8] !== "string") {
                                              const err161 = { instancePath: instancePath + "/action/queries/" + i8, schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/properties/queries/items/type", keyword: "type", params: { type: "string" } };
                                              if (vErrors === null) {
                                                vErrors = [err161];
                                              } else {
                                                vErrors.push(err161);
                                      ...
                                      var valid60 = _errs266 === errors;
                                    } else {
                                      var valid60 = true;
                                    }
                                    if (valid60) {
                                      if (data92.query !== void 0) {
                                        let data95 = data92.query;
                                        const _errs270 = errors;
                                        if (typeof data95 !== "string" && data95 !== null) {
                                          const err162 = { instancePath: instancePath + "/action/query", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/properties/query/type", keyword: "type", params: { type: schema62.oneOf[0].properties.query.type } };
                                          if (vErrors === null) {
                                            vErrors = [err162];
                                          } else {
                                            vErrors.push(err162);
                                        ...
                                        var valid60 = _errs270 === errors;
                                      } else {
                                        var valid60 = true;
                                      }
                                      if (valid60) {
                                        if (data92.type !== void 0) {
                                          let data96 = data92.type;
                                          const _errs272 = errors;
                                          if (typeof data96 !== "string") {
                                            const err163 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err163];
                                            } else {
                                              vErrors.push(err163);
                                          ...
                                          if (!(data96 === "search")) {
                                            const err164 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema62.oneOf[0].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err164];
                                            } else {
                                              vErrors.push(err164);
                                  ...
                                  const err165 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/0/type", keyword: "type", params: { type: "object" } };
                                  if (vErrors === null) {
                                    vErrors = [err165];
                                  } else {
                                    vErrors.push(err165);
                              ...
                              if (errors === _errs274) {
                                if (data92 && typeof data92 == "object" && !Array.isArray(data92)) {
                                  let missing20;
                                  if (data92.type === void 0 && (missing20 = "type")) {
                                    const err166 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/1/required", keyword: "required", params: { missingProperty: missing20 } };
                                    if (vErrors === null) {
                                      vErrors = [err166];
                                    } else {
                                      vErrors.push(err166);
                                    ...
                                    if (data92.type !== void 0) {
                                      let data97 = data92.type;
                                      const _errs276 = errors;
                                      if (typeof data97 !== "string") {
                                        const err167 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/1/properties/type/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err167];
                                        } else {
                                          vErrors.push(err167);
                                      ...
                                      if (!(data97 === "openPage")) {
                                        const err168 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema62.oneOf[1].properties.type.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err168];
                                        } else {
                                          vErrors.push(err168);
                                      ...
                                      var valid62 = _errs276 === errors;
                                    } else {
                                      var valid62 = true;
                                    }
                                    if (valid62) {
                                      if (data92.url !== void 0) {
                                        let data98 = data92.url;
                                        const _errs278 = errors;
                                        if (typeof data98 !== "string" && data98 !== null) {
                                          const err169 = { instancePath: instancePath + "/action/url", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/1/properties/url/type", keyword: "type", params: { type: schema62.oneOf[1].properties.url.type } };
                                          if (vErrors === null) {
                                            vErrors = [err169];
                                          } else {
                                            vErrors.push(err169);
                                  ...
                                  const err170 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/1/type", keyword: "type", params: { type: "object" } };
                                  if (vErrors === null) {
                                    vErrors = [err170];
                                  } else {
                                    vErrors.push(err170);
                              ...
                              if (_valid10 && valid59) {
                                ...
                                if (errors === _errs280) {
                                  if (data92 && typeof data92 == "object" && !Array.isArray(data92)) {
                                    let missing21;
                                    if (data92.type === void 0 && (missing21 = "type")) {
                                      const err171 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/required", keyword: "required", params: { missingProperty: missing21 } };
                                      if (vErrors === null) {
                                        vErrors = [err171];
                                      } else {
                                        vErrors.push(err171);
                                      ...
                                      if (data92.pattern !== void 0) {
                                        let data99 = data92.pattern;
                                        const _errs282 = errors;
                                        if (typeof data99 !== "string" && data99 !== null) {
                                          const err172 = { instancePath: instancePath + "/action/pattern", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/properties/pattern/type", keyword: "type", params: { type: schema62.oneOf[2].properties.pattern.type } };
                                          if (vErrors === null) {
                                            vErrors = [err172];
                                          } else {
                                            vErrors.push(err172);
                                        ...
                                        var valid63 = _errs282 === errors;
                                      } else {
                                        var valid63 = true;
                                      }
                                      if (valid63) {
                                        if (data92.type !== void 0) {
                                          let data100 = data92.type;
                                          const _errs284 = errors;
                                          if (typeof data100 !== "string") {
                                            const err173 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err173];
                                            } else {
                                              vErrors.push(err173);
                                          ...
                                          if (!(data100 === "findInPage")) {
                                            const err174 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema62.oneOf[2].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err174];
                                            } else {
                                              vErrors.push(err174);
                                          ...
                                          var valid63 = _errs284 === errors;
                                        } else {
                                          var valid63 = true;
                                        }
                                        if (valid63) {
                                          if (data92.url !== void 0) {
                                            let data101 = data92.url;
                                            const _errs286 = errors;
                                            if (typeof data101 !== "string" && data101 !== null) {
                                              const err175 = { instancePath: instancePath + "/action/url", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/properties/url/type", keyword: "type", params: { type: schema62.oneOf[2].properties.url.type } };
                                              if (vErrors === null) {
                                                vErrors = [err175];
                                              } else {
                                                vErrors.push(err175);
                                    ...
                                    const err176 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/2/type", keyword: "type", params: { type: "object" } };
                                    if (vErrors === null) {
                                      vErrors = [err176];
                                    } else {
                                      vErrors.push(err176);
                                ...
                                if (_valid10 && valid59) {
                                  ...
                                  if (errors === _errs288) {
                                    if (data92 && typeof data92 == "object" && !Array.isArray(data92)) {
                                      let missing22;
                                      if (data92.type === void 0 && (missing22 = "type")) {
                                        const err177 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/3/required", keyword: "required", params: { missingProperty: missing22 } };
                                        if (vErrors === null) {
                                          vErrors = [err177];
                                        } else {
                                          vErrors.push(err177);
                                        ...
                                        if (data92.type !== void 0) {
                                          let data102 = data92.type;
                                          if (typeof data102 !== "string") {
                                            const err178 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/3/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err178];
                                            } else {
                                              vErrors.push(err178);
                                          ...
                                          if (!(data102 === "other")) {
                                            const err179 = { instancePath: instancePath + "/action/type", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema62.oneOf[3].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err179];
                                            } else {
                                              vErrors.push(err179);
                                      ...
                                      const err180 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf/3/type", keyword: "type", params: { type: "object" } };
                                      if (vErrors === null) {
                                        vErrors = [err180];
                                      } else {
                                        vErrors.push(err180);
                              ...
                              if (!valid59) {
                                const err181 = { instancePath: instancePath + "/action", schemaPath: "#/definitions/v2/WebSearchAction/oneOf", keyword: "oneOf", params: { passingSchemas: passing3 } };
                                if (vErrors === null) {
                                  vErrors = [err181];
                                } else {
                                  vErrors.push(err181);
                              ...
                              var _valid9 = _errs261 === errors;
                              valid57 = valid57 || _valid9;
                              if (!valid57) {
                                const _errs292 = errors;
                                if (data92 !== null) {
                                  const err182 = { instancePath: instancePath + "/action", schemaPath: "#/oneOf/11/properties/action/anyOf/1/type", keyword: "type", params: { type: "null" } };
                                  if (vErrors === null) {
                                    vErrors = [err182];
                                  } else {
                                    vErrors.push(err182);
                                ...
                                var _valid9 = _errs292 === errors;
                                valid57 = valid57 || _valid9;
                              }
                              if (!valid57) {
                                const err183 = { instancePath: instancePath + "/action", schemaPath: "#/oneOf/11/properties/action/anyOf", keyword: "anyOf", params: {} };
                                if (vErrors === null) {
                                  vErrors = [err183];
                                } else {
                                  vErrors.push(err183);
                            ...
                            if (valid56) {
                              if (data.id !== void 0) {
                                ...
                                if (typeof data.id !== "string") {
                                  const err184 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/11/properties/id/type", keyword: "type", params: { type: "string" } };
                                  if (vErrors === null) {
                                    vErrors = [err184];
                                  } else {
                                    vErrors.push(err184);
                              ...
                              if (valid56) {
                                if (data.query !== void 0) {
                                  ...
                                  if (typeof data.query !== "string") {
                                    const err185 = { instancePath: instancePath + "/query", schemaPath: "#/oneOf/11/properties/query/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err185];
                                    } else {
                                      vErrors.push(err185);
                                  ...
                                  var valid56 = _errs296 === errors;
                                } else {
                                  var valid56 = true;
                                }
                                if (valid56) {
                                  if (data.results !== void 0) {
                                    let data105 = data.results;
                                    const _errs298 = errors;
                                    if (!Array.isArray(data105) && data105 !== null) {
                                      const err186 = { instancePath: instancePath + "/results", schemaPath: "#/oneOf/11/properties/results/type", keyword: "type", params: { type: schema32.oneOf[11].properties.results.type } };
                                      if (vErrors === null) {
                                        vErrors = [err186];
                                      } else {
                                        vErrors.push(err186);
                                  ...
                                  if (valid56) {
                                    if (data.type !== void 0) {
                                      ...
                                      if (typeof data106 !== "string") {
                                        const err187 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/11/properties/type/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err187];
                                        } else {
                                          vErrors.push(err187);
                                      ...
                                      if (!(data106 === "webSearch")) {
                                        const err188 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/11/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[11].properties.type.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err188];
                                        } else {
                                          vErrors.push(err188);
                          ...
                          const err189 = { instancePath, schemaPath: "#/oneOf/11/type", keyword: "type", params: { type: "object" } };
                          if (vErrors === null) {
                            vErrors = [err189];
                          } else {
                            vErrors.push(err189);
                        ...
                        if (errors === _errs302) {
                          if (data && typeof data == "object" && !Array.isArray(data)) {
                            ...
                            if (data.id === void 0 && (missing23 = "id") || data.path === void 0 && (missing23 = "path") || data.type === void 0 && (missing23 = "type")) {
                              const err190 = { instancePath, schemaPath: "#/oneOf/12/required", keyword: "required", params: { missingProperty: missing23 } };
                              if (vErrors === null) {
                                vErrors = [err190];
                              } else {
                                vErrors.push(err190);
                              ...
                              if (data.id !== void 0) {
                                ...
                                if (typeof data.id !== "string") {
                                  const err191 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/12/properties/id/type", keyword: "type", params: { type: "string" } };
                                  if (vErrors === null) {
                                    vErrors = [err191];
                                  } else {
                                    vErrors.push(err191);
                              ...
                              if (valid65) {
                                if (data.path !== void 0) {
                                  ...
                                  if (typeof data.path !== "string") {
                                    const err192 = { instancePath: instancePath + "/path", schemaPath: "#/definitions/v2/LegacyAppPathString/type", keyword: "type", params: { type: "string" } };
                                    if (vErrors === null) {
                                      vErrors = [err192];
                                    } else {
                                      vErrors.push(err192);
                                ...
                                if (valid65) {
                                  if (data.type !== void 0) {
                                    ...
                                    if (typeof data109 !== "string") {
                                      const err193 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/12/properties/type/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err193];
                                      } else {
                                        vErrors.push(err193);
                                    ...
                                    if (!(data109 === "imageView")) {
                                      const err194 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/12/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[12].properties.type.enum } };
                                      if (vErrors === null) {
                                        vErrors = [err194];
                                      } else {
                                        vErrors.push(err194);
                            ...
                            const err195 = { instancePath, schemaPath: "#/oneOf/12/type", keyword: "type", params: { type: "object" } };
                            if (vErrors === null) {
                              vErrors = [err195];
                            } else {
                              vErrors.push(err195);
                          ...
                          if (errors === _errs311) {
                            if (data && typeof data == "object" && !Array.isArray(data)) {
                              ...
                              if (data.durationMs === void 0 && (missing24 = "durationMs") || data.id === void 0 && (missing24 = "id") || data.type === void 0 && (missing24 = "type")) {
                                const err196 = { instancePath, schemaPath: "#/oneOf/13/required", keyword: "required", params: { missingProperty: missing24 } };
                                if (vErrors === null) {
                                  vErrors = [err196];
                                } else {
                                  vErrors.push(err196);
                                ...
                                if (data.durationMs !== void 0) {
                                  let data110 = data.durationMs;
                                  const _errs313 = errors;
                                  if (!(typeof data110 == "number" && (!(data110 % 1) && !isNaN(data110)) && isFinite(data110))) {
                                    const err197 = { instancePath: instancePath + "/durationMs", schemaPath: "#/oneOf/13/properties/durationMs/type", keyword: "type", params: { type: "integer" } };
                                    if (vErrors === null) {
                                      vErrors = [err197];
                                    } else {
                                      vErrors.push(err197);
                                  ...
                                  if (errors === _errs313) {
                                    if (typeof data110 == "number" && isFinite(data110)) {
                                      if (data110 < 0 || isNaN(data110)) {
                                        const err198 = { instancePath: instancePath + "/durationMs", schemaPath: "#/oneOf/13/properties/durationMs/minimum", keyword: "minimum", params: { comparison: ">=", limit: 0 } };
                                        if (vErrors === null) {
                                          vErrors = [err198];
                                        } else {
                                          vErrors.push(err198);
                                ...
                                if (valid67) {
                                  if (data.id !== void 0) {
                                    ...
                                    if (typeof data.id !== "string") {
                                      const err199 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/13/properties/id/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err199];
                                      } else {
                                        vErrors.push(err199);
                                  ...
                                  if (valid67) {
                                    if (data.type !== void 0) {
                                      ...
                                      if (typeof data112 !== "string") {
                                        const err200 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/13/properties/type/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err200];
                                        } else {
                                          vErrors.push(err200);
                                      ...
                                      if (!(data112 === "sleep")) {
                                        const err201 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/13/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[13].properties.type.enum } };
                                        if (vErrors === null) {
                                          vErrors = [err201];
                                        } else {
                                          vErrors.push(err201);
                              ...
                              const err202 = { instancePath, schemaPath: "#/oneOf/13/type", keyword: "type", params: { type: "object" } };
                              if (vErrors === null) {
                                vErrors = [err202];
                              } else {
                                vErrors.push(err202);
                            ...
                            if (errors === _errs319) {
                              if (data && typeof data == "object" && !Array.isArray(data)) {
                                ...
                                if (data.id === void 0 && (missing25 = "id") || data.result === void 0 && (missing25 = "result") || data.status === void 0 && (missing25 = "status") || data.type === void 0 && (missing25 = "type")) {
                                  const err203 = { instancePath, schemaPath: "#/oneOf/14/required", keyword: "required", params: { missingProperty: missing25 } };
                                  if (vErrors === null) {
                                    vErrors = [err203];
                                  } else {
                                    vErrors.push(err203);
                                  ...
                                  if (data.id !== void 0) {
                                    ...
                                    if (typeof data.id !== "string") {
                                      const err204 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/14/properties/id/type", keyword: "type", params: { type: "string" } };
                                      if (vErrors === null) {
                                        vErrors = [err204];
                                      } else {
                                        vErrors.push(err204);
                                  ...
                                  if (valid68) {
                                    if (data.result !== void 0) {
                                      ...
                                      if (typeof data.result !== "string") {
                                        const err205 = { instancePath: instancePath + "/result", schemaPath: "#/oneOf/14/properties/result/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err205];
                                        } else {
                                          vErrors.push(err205);
                                      ...
                                      var valid68 = _errs323 === errors;
                                    } else {
                                      var valid68 = true;
                                    }
                                    if (valid68) {
                                      if (data.revisedPrompt !== void 0) {
                                        let data115 = data.revisedPrompt;
                                        const _errs325 = errors;
                                        if (typeof data115 !== "string" && data115 !== null) {
                                          const err206 = { instancePath: instancePath + "/revisedPrompt", schemaPath: "#/oneOf/14/properties/revisedPrompt/type", keyword: "type", params: { type: schema32.oneOf[14].properties.revisedPrompt.type } };
                                          if (vErrors === null) {
                                            vErrors = [err206];
                                          } else {
                                            vErrors.push(err206);
                                      ...
                                      if (valid68) {
                                        if (data.savedPath !== void 0) {
                                          let data116 = data.savedPath;
                                          const _errs327 = errors;
                                          const _errs328 = errors;
                                          let valid69 = false;
                                          const _errs329 = errors;
                                          if (typeof data116 !== "string") {
                                            const err207 = { instancePath: instancePath + "/savedPath", schemaPath: "#/definitions/v2/AbsolutePathBuf/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err207];
                                            } else {
                                              vErrors.push(err207);
                                          ...
                                          if (!valid69) {
                                            ...
                                            if (data116 !== null) {
                                              const err208 = { instancePath: instancePath + "/savedPath", schemaPath: "#/oneOf/14/properties/savedPath/anyOf/1/type", keyword: "type", params: { type: "null" } };
                                              if (vErrors === null) {
                                                vErrors = [err208];
                                              } else {
                                                vErrors.push(err208);
                                            ...
                                            var _valid11 = _errs332 === errors;
                                            valid69 = valid69 || _valid11;
                                          }
                                          if (!valid69) {
                                            const err209 = { instancePath: instancePath + "/savedPath", schemaPath: "#/oneOf/14/properties/savedPath/anyOf", keyword: "anyOf", params: {} };
                                            if (vErrors === null) {
                                              vErrors = [err209];
                                            } else {
                                              vErrors.push(err209);
                                        ...
                                        if (valid68) {
                                          if (data.status !== void 0) {
                                            ...
                                            if (typeof data.status !== "string") {
                                              const err210 = { instancePath: instancePath + "/status", schemaPath: "#/oneOf/14/properties/status/type", keyword: "type", params: { type: "string" } };
                                              if (vErrors === null) {
                                                vErrors = [err210];
                                              } else {
                                                vErrors.push(err210);
                                          ...
                                          if (valid68) {
                                            if (data.type !== void 0) {
                                              ...
                                              if (typeof data118 !== "string") {
                                                const err211 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/14/properties/type/type", keyword: "type", params: { type: "string" } };
                                                if (vErrors === null) {
                                                  vErrors = [err211];
                                                } else {
                                                  vErrors.push(err211);
                                              ...
                                              if (!(data118 === "imageGeneration")) {
                                                const err212 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/14/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[14].properties.type.enum } };
                                                if (vErrors === null) {
                                                  vErrors = [err212];
                                                } else {
                                                  vErrors.push(err212);
                                ...
                                const err213 = { instancePath, schemaPath: "#/oneOf/14/type", keyword: "type", params: { type: "object" } };
                                if (vErrors === null) {
                                  vErrors = [err213];
                                } else {
                                  vErrors.push(err213);
                              ...
                              if (errors === _errs338) {
                                if (data && typeof data == "object" && !Array.isArray(data)) {
                                  ...
                                  if (data.id === void 0 && (missing26 = "id") || data.review === void 0 && (missing26 = "review") || data.type === void 0 && (missing26 = "type")) {
                                    const err214 = { instancePath, schemaPath: "#/oneOf/15/required", keyword: "required", params: { missingProperty: missing26 } };
                                    if (vErrors === null) {
                                      vErrors = [err214];
                                    } else {
                                      vErrors.push(err214);
                                    ...
                                    if (data.id !== void 0) {
                                      ...
                                      if (typeof data.id !== "string") {
                                        const err215 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/15/properties/id/type", keyword: "type", params: { type: "string" } };
                                        if (vErrors === null) {
                                          vErrors = [err215];
                                        } else {
                                          vErrors.push(err215);
                                    ...
                                    if (valid71) {
                                      if (data.review !== void 0) {
                                        ...
                                        if (typeof data.review !== "string") {
                                          const err216 = { instancePath: instancePath + "/review", schemaPath: "#/oneOf/15/properties/review/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err216];
                                          } else {
                                            vErrors.push(err216);
                                      ...
                                      if (valid71) {
                                        if (data.type !== void 0) {
                                          ...
                                          if (typeof data121 !== "string") {
                                            const err217 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/15/properties/type/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err217];
                                            } else {
                                              vErrors.push(err217);
                                          ...
                                          if (!(data121 === "enteredReviewMode")) {
                                            const err218 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/15/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[15].properties.type.enum } };
                                            if (vErrors === null) {
                                              vErrors = [err218];
                                            } else {
                                              vErrors.push(err218);
                                  ...
                                  const err219 = { instancePath, schemaPath: "#/oneOf/15/type", keyword: "type", params: { type: "object" } };
                                  if (vErrors === null) {
                                    vErrors = [err219];
                                  } else {
                                    vErrors.push(err219);
                              ...
                              if (_valid0 && valid0) {
                                ...
                                if (errors === _errs346) {
                                  if (data && typeof data == "object" && !Array.isArray(data)) {
                                    ...
                                    if (data.id === void 0 && (missing27 = "id") || data.review === void 0 && (missing27 = "review") || data.type === void 0 && (missing27 = "type")) {
                                      const err220 = { instancePath, schemaPath: "#/oneOf/16/required", keyword: "required", params: { missingProperty: missing27 } };
                                      if (vErrors === null) {
                                        vErrors = [err220];
                                      } else {
                                        vErrors.push(err220);
                                      ...
                                      if (data.id !== void 0) {
                                        ...
                                        if (typeof data.id !== "string") {
                                          const err221 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/16/properties/id/type", keyword: "type", params: { type: "string" } };
                                          if (vErrors === null) {
                                            vErrors = [err221];
                                          } else {
                                            vErrors.push(err221);
                                      ...
                                      if (valid72) {
                                        if (data.review !== void 0) {
                                          ...
                                          if (typeof data.review !== "string") {
                                            const err222 = { instancePath: instancePath + "/review", schemaPath: "#/oneOf/16/properties/review/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err222];
                                            } else {
                                              vErrors.push(err222);
                                        ...
                                        if (valid72) {
                                          if (data.type !== void 0) {
                                            ...
                                            if (typeof data124 !== "string") {
                                              const err223 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/16/properties/type/type", keyword: "type", params: { type: "string" } };
                                              if (vErrors === null) {
                                                vErrors = [err223];
                                              } else {
                                                vErrors.push(err223);
                                            ...
                                            if (!(data124 === "exitedReviewMode")) {
                                              const err224 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/16/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[16].properties.type.enum } };
                                              if (vErrors === null) {
                                                vErrors = [err224];
                                              } else {
                                                vErrors.push(err224);
                                    ...
                                    const err225 = { instancePath, schemaPath: "#/oneOf/16/type", keyword: "type", params: { type: "object" } };
                                    if (vErrors === null) {
                                      vErrors = [err225];
                                    } else {
                                      vErrors.push(err225);
                                ...
                                if (_valid0 && valid0) {
                                  ...
                                  if (errors === _errs354) {
                                    if (data && typeof data == "object" && !Array.isArray(data)) {
                                      let missing28;
                                      if (data.id === void 0 && (missing28 = "id") || data.type === void 0 && (missing28 = "type")) {
                                        const err226 = { instancePath, schemaPath: "#/oneOf/17/required", keyword: "required", params: { missingProperty: missing28 } };
                                        if (vErrors === null) {
                                          vErrors = [err226];
                                        } else {
                                          vErrors.push(err226);
                                        ...
                                        if (data.id !== void 0) {
                                          ...
                                          if (typeof data.id !== "string") {
                                            const err227 = { instancePath: instancePath + "/id", schemaPath: "#/oneOf/17/properties/id/type", keyword: "type", params: { type: "string" } };
                                            if (vErrors === null) {
                                              vErrors = [err227];
                                            } else {
                                              vErrors.push(err227);
                                        ...
                                        if (valid73) {
                                          if (data.type !== void 0) {
                                            ...
                                            if (typeof data126 !== "string") {
                                              const err228 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/17/properties/type/type", keyword: "type", params: { type: "string" } };
                                              if (vErrors === null) {
                                                vErrors = [err228];
                                              } else {
                                                vErrors.push(err228);
                                            ...
                                            if (!(data126 === "contextCompaction")) {
                                              const err229 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/17/properties/type/enum", keyword: "enum", params: { allowedValues: schema32.oneOf[17].properties.type.enum } };
                                              if (vErrors === null) {
                                                vErrors = [err229];
                                              } else {
                                                vErrors.push(err229);
                                      ...
                                      const err230 = { instancePath, schemaPath: "#/oneOf/17/type", keyword: "type", params: { type: "object" } };
                                      if (vErrors === null) {
                                        vErrors = [err230];
                                      } else {
                                        vErrors.push(err230);
  ...
  if (!valid0) {
    const err231 = { instancePath, schemaPath: "#/oneOf", keyword: "oneOf", params: { passingSchemas: passing0 } };
    if (vErrors === null) {
      vErrors = [err231];
    } else {
      vErrors.push(err231);
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.id === void 0 && (missing0 = "id") || data.items === void 0 && (missing0 = "items") || data.status === void 0 && (missing0 = "status")) {
        validate24.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 } }];
        return false;
      } else {
        if (data.completedAt !== void 0) {
          ...
          if (!(typeof data0 == "number" && (!(data0 % 1) && !isNaN(data0)) && isFinite(data0)) && data0 !== null) {
            validate24.errors = [{ instancePath: instancePath + "/completedAt", schemaPath: "#/properties/completedAt/type", keyword: "type", params: { type: schema28.properties.completedAt.type } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          if (data.durationMs !== void 0) {
            ...
            const _errs3 = errors;
            if (!(typeof data1 == "number" && (!(data1 % 1) && !isNaN(data1)) && isFinite(data1)) && data1 !== null) {
              validate24.errors = [{ instancePath: instancePath + "/durationMs", schemaPath: "#/properties/durationMs/type", keyword: "type", params: { type: schema28.properties.durationMs.type } }];
              return false;
            }
            var valid0 = _errs3 === errors;
          } else {
          ...
          if (valid0) {
            ...
            if (valid0) {
              if (data.id !== void 0) {
                const _errs10 = errors;
                if (typeof data.id !== "string") {
                  validate24.errors = [{ instancePath: instancePath + "/id", schemaPath: "#/properties/id/type", keyword: "type", params: { type: "string" } }];
                  return false;
                }
              ...
              if (valid0) {
                if (data.items !== void 0) {
                  ...
                  if (errors === _errs12) {
                    if (Array.isArray(data4)) {
                      ...
                      validate24.errors = [{ instancePath: instancePath + "/items", schemaPath: "#/properties/items/type", keyword: "type", params: { type: "array" } }];
                      return false;
                    }
                  }
                ...
                if (valid0) {
                  if (data.itemsView !== void 0) {
                    ...
                    if (!(data6 === "notLoaded")) {
                      const err3 = { instancePath: instancePath + "/itemsView", schemaPath: "#/definitions/v2/TurnItemsView/oneOf/0/enum", keyword: "enum", params: { allowedValues: schema65.oneOf[0].enum } };
                      if (vErrors === null) {
                        vErrors = [err3];
                      } else {
                        vErrors.push(err3);
                    ...
                    if (!(data6 === "summary")) {
                      const err5 = { instancePath: instancePath + "/itemsView", schemaPath: "#/definitions/v2/TurnItemsView/oneOf/1/enum", keyword: "enum", params: { allowedValues: schema65.oneOf[1].enum } };
                      if (vErrors === null) {
                        vErrors = [err5];
                      } else {
                        vErrors.push(err5);
                    ...
                    if (_valid1 && valid5) {
                      ...
                      if (!(data6 === "full")) {
                        const err7 = { instancePath: instancePath + "/itemsView", schemaPath: "#/definitions/v2/TurnItemsView/oneOf/2/enum", keyword: "enum", params: { allowedValues: schema65.oneOf[2].enum } };
                        if (vErrors === null) {
                          vErrors = [err7];
                        } else {
                          vErrors.push(err7);
                  ...
                  if (valid0) {
                    if (data.startedAt !== void 0) {
                      ...
                      const _errs25 = errors;
                      if (!(typeof data7 == "number" && (!(data7 % 1) && !isNaN(data7)) && isFinite(data7)) && data7 !== null) {
                        validate24.errors = [{ instancePath: instancePath + "/startedAt", schemaPath: "#/properties/startedAt/type", keyword: "type", params: { type: schema28.properties.startedAt.type } }];
                        return false;
                      }
                    ...
                    if (valid0) {
                      if (data.status !== void 0) {
                        ...
                        if (typeof data8 !== "string") {
                          validate24.errors = [{ instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/TurnStatus/type", keyword: "type", params: { type: "string" } }];
                          return false;
                        }
                        if (!(data8 === "completed" || data8 === "interrupted" || data8 === "failed" || data8 === "inProgress")) {
                          validate24.errors = [{ instancePath: instancePath + "/status", schemaPath: "#/definitions/v2/TurnStatus/enum", keyword: "enum", params: { allowedValues: schema66.enum } }];
                          return false;
                        }
      ...
      validate24.errors = [{ instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" } }];
      return false;
    }
  }
  validate24.errors = vErrors;
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.cliVersion === void 0 && (missing0 = "cliVersion") || data.createdAt === void 0 && (missing0 = "createdAt") || data.cwd === void 0 && (missing0 = "cwd") || data.ephemeral === void 0 && (missing0 = "ephemeral") || data.id === void 0 && (missing0 = "id") || data.modelProvider === void 0 && (missing0 = "modelProvider") || data.preview === void 0 && (missing0 = "preview") || data.sessionId === void 0 && (missing0 = "sessionId") || data.source === void 0 && (missing0 = "source") || data.status === void 0 && (missing0 = "status") || data.turns === void 0 && (missing0 = "turns") || data.updatedAt === void 0 && (missing0 = "updatedAt")) {
        ...
        if (data.agentNickname !== void 0) {
          ...
          const _errs1 = errors;
          if (typeof data0 !== "string" && data0 !== null) {
            validate17.errors = [{ instancePath: instancePath + "/agentNickname", schemaPath: "#/properties/agentNickname/type", keyword: "type", params: { type: schema18.properties.agentNickname.type } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          if (data.agentRole !== void 0) {
            ...
            const _errs3 = errors;
            if (typeof data1 !== "string" && data1 !== null) {
              validate17.errors = [{ instancePath: instancePath + "/agentRole", schemaPath: "#/properties/agentRole/type", keyword: "type", params: { type: schema18.properties.agentRole.type } }];
              return false;
            }
            var valid0 = _errs3 === errors;
          } else {
          ...
          if (valid0) {
            if (data.cliVersion !== void 0) {
              ...
              if (typeof data.cliVersion !== "string") {
                validate17.errors = [{ instancePath: instancePath + "/cliVersion", schemaPath: "#/properties/cliVersion/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
              var valid0 = _errs5 === errors;
            } else {
            ...
            if (valid0) {
              if (data.createdAt !== void 0) {
                ...
                const _errs7 = errors;
                if (!(typeof data3 == "number" && (!(data3 % 1) && !isNaN(data3)) && isFinite(data3))) {
                  validate17.errors = [{ instancePath: instancePath + "/createdAt", schemaPath: "#/properties/createdAt/type", keyword: "type", params: { type: "integer" } }];
                  return false;
                }
                var valid0 = _errs7 === errors;
              } else {
              ...
              if (valid0) {
                if (data.cwd !== void 0) {
                  const _errs9 = errors;
                  if (typeof data.cwd !== "string") {
                    validate17.errors = [{ instancePath: instancePath + "/cwd", schemaPath: "#/definitions/v2/AbsolutePathBuf/type", keyword: "type", params: { type: "string" } }];
                    return false;
                  }
                  var valid0 = _errs9 === errors;
                } else {
                ...
                if (valid0) {
                  if (data.ephemeral !== void 0) {
                    ...
                    if (typeof data.ephemeral !== "boolean") {
                      validate17.errors = [{ instancePath: instancePath + "/ephemeral", schemaPath: "#/properties/ephemeral/type", keyword: "type", params: { type: "boolean" } }];
                      return false;
                    }
                  ...
                  if (valid0) {
                    if (data.forkedFromId !== void 0) {
                      ...
                      if (typeof data6 !== "string" && data6 !== null) {
                        validate17.errors = [{ instancePath: instancePath + "/forkedFromId", schemaPath: "#/properties/forkedFromId/type", keyword: "type", params: { type: schema18.properties.forkedFromId.type } }];
                        return false;
                      }
                      var valid0 = _errs15 === errors;
                    } else {
                    ...
                    if (valid0) {
                        ...
                        if (errors === _errs20) {
                          if (data7 && typeof data7 == "object" && !Array.isArray(data7)) {
                            if (data7.branch !== void 0) {
                              ...
                              const _errs22 = errors;
                              if (typeof data8 !== "string" && data8 !== null) {
                                const err0 = { instancePath: instancePath + "/gitInfo/branch", schemaPath: "#/definitions/v2/GitInfo/properties/branch/type", keyword: "type", params: { type: schema20.properties.branch.type } };
                                if (vErrors === null) {
                                  vErrors = [err0];
                                } else {
                                  vErrors.push(err0);
                            ...
                            if (valid5) {
                              if (data7.originUrl !== void 0) {
                                ...
                                const _errs24 = errors;
                                if (typeof data9 !== "string" && data9 !== null) {
                                  const err1 = { instancePath: instancePath + "/gitInfo/originUrl", schemaPath: "#/definitions/v2/GitInfo/properties/originUrl/type", keyword: "type", params: { type: schema20.properties.originUrl.type } };
                                  if (vErrors === null) {
                                    vErrors = [err1];
                                  } else {
                                    vErrors.push(err1);
                              ...
                              if (valid5) {
                                if (data7.sha !== void 0) {
                                  ...
                                  if (typeof data10 !== "string" && data10 !== null) {
                                    const err2 = { instancePath: instancePath + "/gitInfo/sha", schemaPath: "#/definitions/v2/GitInfo/properties/sha/type", keyword: "type", params: { type: schema20.properties.sha.type } };
                                    if (vErrors === null) {
                                      vErrors = [err2];
                                    } else {
                                      vErrors.push(err2);
                      ...
                      if (valid0) {
                        if (data.id !== void 0) {
                          const _errs30 = errors;
                          if (typeof data.id !== "string") {
                            validate17.errors = [{ instancePath: instancePath + "/id", schemaPath: "#/properties/id/type", keyword: "type", params: { type: "string" } }];
                            return false;
                          }
                        ...
                        if (valid0) {
                          if (data.modelProvider !== void 0) {
                            ...
                            if (typeof data.modelProvider !== "string") {
                              validate17.errors = [{ instancePath: instancePath + "/modelProvider", schemaPath: "#/properties/modelProvider/type", keyword: "type", params: { type: "string" } }];
                              return false;
                            }
                          ...
                          if (valid0) {
                            if (data.name !== void 0) {
                              ...
                              if (typeof data13 !== "string" && data13 !== null) {
                                validate17.errors = [{ instancePath: instancePath + "/name", schemaPath: "#/properties/name/type", keyword: "type", params: { type: schema18.properties.name.type } }];
                                return false;
                              }
                            ...
                            if (valid0) {
                              if (data.parentThreadId !== void 0) {
                                ...
                                if (typeof data14 !== "string" && data14 !== null) {
                                  validate17.errors = [{ instancePath: instancePath + "/parentThreadId", schemaPath: "#/properties/parentThreadId/type", keyword: "type", params: { type: schema18.properties.parentThreadId.type } }];
                                  return false;
                                }
                              ...
                              if (valid0) {
                                if (data.path !== void 0) {
                                  ...
                                  if (typeof data15 !== "string" && data15 !== null) {
                                    validate17.errors = [{ instancePath: instancePath + "/path", schemaPath: "#/properties/path/type", keyword: "type", params: { type: schema18.properties.path.type } }];
                                    return false;
                                  }
                                ...
                                if (valid0) {
                                  if (data.preview !== void 0) {
                                    ...
                                    if (typeof data.preview !== "string") {
                                      validate17.errors = [{ instancePath: instancePath + "/preview", schemaPath: "#/properties/preview/type", keyword: "type", params: { type: "string" } }];
                                      return false;
                                    }
                                  ...
                                  if (valid0) {
                                    if (data.recencyAt !== void 0) {
                                      ...
                                      if (!(typeof data17 == "number" && (!(data17 % 1) && !isNaN(data17)) && isFinite(data17)) && data17 !== null) {
                                        validate17.errors = [{ instancePath: instancePath + "/recencyAt", schemaPath: "#/properties/recencyAt/type", keyword: "type", params: { type: schema18.properties.recencyAt.type } }];
                                        return false;
                                      }
                                    ...
                                    if (valid0) {
                                      if (data.sessionId !== void 0) {
                                        ...
                                        if (typeof data.sessionId !== "string") {
                                          validate17.errors = [{ instancePath: instancePath + "/sessionId", schemaPath: "#/properties/sessionId/type", keyword: "type", params: { type: "string" } }];
                                          return false;
                                        }
                                          ...
                                          if (valid0) {
                                            if (data.threadSource !== void 0) {
                                              ...
                                              if (typeof data21 !== "string") {
                                                const err6 = { instancePath: instancePath + "/threadSource", schemaPath: "#/definitions/v2/ThreadSource/type", keyword: "type", params: { type: "string" } };
                                                if (vErrors === null) {
                                                  vErrors = [err6];
                                                } else {
                                                  vErrors.push(err6);
                                              ...
                                              if (!valid8) {
                                                const _errs55 = errors;
                                                if (data21 !== null) {
                                                  const err7 = { instancePath: instancePath + "/threadSource", schemaPath: "#/properties/threadSource/anyOf/1/type", keyword: "type", params: { type: "null" } };
                                                  if (vErrors === null) {
                                                    vErrors = [err7];
                                                  } else {
                                                    vErrors.push(err7);
                                              ...
                                              if (!valid8) {
                                                const err8 = { instancePath: instancePath + "/threadSource", schemaPath: "#/properties/threadSource/anyOf", keyword: "anyOf", params: {} };
                                                if (vErrors === null) {
                                                  vErrors = [err8];
                                                } else {
                                                  vErrors.push(err8);
                                              ...
                                              if (data.turns !== void 0) {
                                                ...
                                                if (errors === _errs57) {
                                                  if (Array.isArray(data22)) {
                                                    ...
                                                    validate17.errors = [{ instancePath: instancePath + "/turns", schemaPath: "#/properties/turns/type", keyword: "type", params: { type: "array" } }];
                                                    return false;
                                                  }
                                                }
                                              ...
                                              if (valid0) {
                                                if (data.updatedAt !== void 0) {
                                                  ...
                                                  if (!(typeof data24 == "number" && (!(data24 % 1) && !isNaN(data24)) && isFinite(data24))) {
                                                    validate17.errors = [{ instancePath: instancePath + "/updatedAt", schemaPath: "#/properties/updatedAt/type", keyword: "type", params: { type: "integer" } }];
                                                    return false;
                                                  }
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.thread === void 0 && (missing0 = "thread")) {
        ...
        if (data.headCommitId !== void 0) {
          ...
          const _errs1 = errors;
          if (typeof data0 !== "string" && data0 !== null) {
            validate16.errors = [{ instancePath: instancePath + "/headCommitId", schemaPath: "#/properties/headCommitId/type", keyword: "type", params: { type: schema17.properties.headCommitId.type } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          if (data.subscriptionId !== void 0) {
            ...
            if (typeof data.subscriptionId !== "string") {
              validate15.errors = [{ instancePath: instancePath + "/subscriptionId", schemaPath: "#/properties/subscriptionId/type", keyword: "type", params: { type: "string" } }];
              return false;
            }
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.reason === void 0 && (missing0 = "reason") || data.subscriptionId === void 0 && (missing0 = "subscriptionId") || data.threadId === void 0 && (missing0 = "threadId")) {
        validate48.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 } }];
        return false;
      } else {
        if (data.reason !== void 0) {
          ...
          const _errs1 = errors;
          if (typeof data0 !== "string") {
            validate48.errors = [{ instancePath: instancePath + "/reason", schemaPath: "#/definitions/v2/ThreadProjectionClosedReason/type", keyword: "type", params: { type: "string" } }];
            return false;
          }
          if (!(data0 === "backpressure")) {
            validate48.errors = [{ instancePath: instancePath + "/reason", schemaPath: "#/definitions/v2/ThreadProjectionClosedReason/enum", keyword: "enum", params: { allowedValues: schema69.enum } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          if (data.subscriptionId !== void 0) {
            const _errs4 = errors;
            if (typeof data.subscriptionId !== "string") {
              validate48.errors = [{ instancePath: instancePath + "/subscriptionId", schemaPath: "#/properties/subscriptionId/type", keyword: "type", params: { type: "string" } }];
              return false;
            }
          ...
          if (valid0) {
            if (data.threadId !== void 0) {
              ...
              if (typeof data.threadId !== "string") {
                validate48.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
      ...
      validate48.errors = [{ instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" } }];
      return false;
    }
  }
        ...
        if (valid1) {
          if (data.type !== void 0) {
            ...
            if (!(data5 === "agentMessage")) {
              const err8 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema72.oneOf[0].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err8];
              } else {
                vErrors.push(err8);
        ...
        if (valid4) {
          if (data.type !== void 0) {
            ...
            if (!(data12 === "reasoningSummaryText")) {
              const err19 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema72.oneOf[1].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err19];
              } else {
                vErrors.push(err19);
          ...
          if (valid7) {
            if (data.type !== void 0) {
              ...
              if (!(data18 === "reasoningSummaryPartAdded")) {
                const err29 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema72.oneOf[2].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err29];
                } else {
                  vErrors.push(err29);
            ...
            if (valid10) {
              if (data.type !== void 0) {
                ...
                if (!(data25 === "reasoningText")) {
                  const err40 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema72.oneOf[3].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err40];
                  } else {
                    vErrors.push(err40);
      ...
      if (data.delta === void 0 && (missing0 = "delta") || data.subscriptionId === void 0 && (missing0 = "subscriptionId") || data.threadId === void 0 && (missing0 = "threadId")) {
        ...
        if (valid0) {
          if (data.subscriptionId !== void 0) {
            const _errs2 = errors;
            if (typeof data.subscriptionId !== "string") {
              validate51.errors = [{ instancePath: instancePath + "/subscriptionId", schemaPath: "#/properties/subscriptionId/type", keyword: "type", params: { type: "string" } }];
              return false;
            }
            var valid0 = _errs2 === errors;
          } else {
          ...
          if (valid0) {
            if (data.threadId !== void 0) {
              const _errs4 = errors;
              if (typeof data.threadId !== "string") {
                validate51.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
              var valid0 = _errs4 === errors;
            } else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.threadId === void 0 && (missing0 = "threadId") || data.turn === void 0 && (missing0 = "turn")) {
        ...
        if (data.threadId !== void 0) {
          const _errs1 = errors;
          if (typeof data.threadId !== "string") {
            validate58.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.threadId === void 0 && (missing0 = "threadId") || data.turn === void 0 && (missing0 = "turn")) {
        ...
        if (data.threadId !== void 0) {
          const _errs1 = errors;
          if (typeof data.threadId !== "string") {
            validate61.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
      ...
      if (data.item === void 0 && (missing0 = "item") || data.startedAtMs === void 0 && (missing0 = "startedAtMs") || data.threadId === void 0 && (missing0 = "threadId") || data.turnId === void 0 && (missing0 = "turnId")) {
        ...
        if (valid0) {
          if (data.startedAtMs !== void 0) {
            ...
            const _errs2 = errors;
            if (!(typeof data1 == "number" && (!(data1 % 1) && !isNaN(data1)) && isFinite(data1))) {
              validate64.errors = [{ instancePath: instancePath + "/startedAtMs", schemaPath: "#/properties/startedAtMs/type", keyword: "type", params: { type: "integer" } }];
              return false;
            }
            var valid0 = _errs2 === errors;
          } else {
          ...
          if (valid0) {
            if (data.threadId !== void 0) {
              const _errs4 = errors;
              if (typeof data.threadId !== "string") {
                validate64.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
              var valid0 = _errs4 === errors;
            } else {
            ...
            if (valid0) {
              if (data.turnId !== void 0) {
                ...
                if (typeof data.turnId !== "string") {
                  validate64.errors = [{ instancePath: instancePath + "/turnId", schemaPath: "#/properties/turnId/type", keyword: "type", params: { type: "string" } }];
                  return false;
                }
                var valid0 = _errs6 === errors;
              } else {
      ...
      if (data.completedAtMs === void 0 && (missing0 = "completedAtMs") || data.item === void 0 && (missing0 = "item") || data.threadId === void 0 && (missing0 = "threadId") || data.turnId === void 0 && (missing0 = "turnId")) {
        ...
        if (data.completedAtMs !== void 0) {
          ...
          if (!(typeof data0 == "number" && (!(data0 % 1) && !isNaN(data0)) && isFinite(data0))) {
            validate67.errors = [{ instancePath: instancePath + "/completedAtMs", schemaPath: "#/properties/completedAtMs/type", keyword: "type", params: { type: "integer" } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
        ...
        if (valid0) {
          ...
          if (valid0) {
            if (data.threadId !== void 0) {
              const _errs4 = errors;
              if (typeof data.threadId !== "string") {
                validate67.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
                return false;
              }
              var valid0 = _errs4 === errors;
            } else {
            ...
            if (valid0) {
              if (data.turnId !== void 0) {
                const _errs6 = errors;
                if (typeof data.turnId !== "string") {
                  validate67.errors = [{ instancePath: instancePath + "/turnId", schemaPath: "#/properties/turnId/type", keyword: "type", params: { type: "string" } }];
                  return false;
                }
                var valid0 = _errs6 === errors;
              } else {
...
function validate57(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
        ...
        if (valid1) {
          if (data.type !== void 0) {
            ...
            if (!(data1 === "turnStarted")) {
              const err2 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/0/properties/type/enum", keyword: "enum", params: { allowedValues: schema79.oneOf[0].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err2];
              } else {
                vErrors.push(err2);
        ...
        if (valid2) {
          if (data.type !== void 0) {
            ...
            if (!(data3 === "turnCompleted")) {
              const err6 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/1/properties/type/enum", keyword: "enum", params: { allowedValues: schema79.oneOf[1].properties.type.enum } };
              if (vErrors === null) {
                vErrors = [err6];
              } else {
                vErrors.push(err6);
          ...
          if (valid3) {
            if (data.type !== void 0) {
              ...
              if (!(data5 === "itemStarted")) {
                const err10 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/2/properties/type/enum", keyword: "enum", params: { allowedValues: schema79.oneOf[2].properties.type.enum } };
                if (vErrors === null) {
                  vErrors = [err10];
                } else {
                  vErrors.push(err10);
            ...
            if (valid4) {
              if (data.type !== void 0) {
                ...
                if (!(data7 === "itemCompleted")) {
                  const err14 = { instancePath: instancePath + "/type", schemaPath: "#/oneOf/3/properties/type/enum", keyword: "enum", params: { allowedValues: schema79.oneOf[3].properties.type.enum } };
                  if (vErrors === null) {
                    vErrors = [err14];
                  } else {
                    vErrors.push(err14);
  ...
  if (!valid0) {
    const err16 = { instancePath, schemaPath: "#/oneOf", keyword: "oneOf", params: { passingSchemas: passing0 } };
    if (vErrors === null) {
      vErrors = [err16];
    } else {
      vErrors.push(err16);
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.commitId === void 0 && (missing0 = "commitId") || data.event === void 0 && (missing0 = "event") || data.subscriptionId === void 0 && (missing0 = "subscriptionId") || data.threadId === void 0 && (missing0 = "threadId")) {
        validate56.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing0 } }];
        return false;
      } else {
        if (data.commitId !== void 0) {
          const _errs1 = errors;
          if (typeof data.commitId !== "string") {
            validate56.errors = [{ instancePath: instancePath + "/commitId", schemaPath: "#/properties/commitId/type", keyword: "type", params: { type: "string" } }];
            return false;
          }
          var valid0 = _errs1 === errors;
        } else {
          ...
          if (valid0) {
            if (data.parentCommitId !== void 0) {
              ...
              if (typeof data2 !== "string" && data2 !== null) {
                validate56.errors = [{ instancePath: instancePath + "/parentCommitId", schemaPath: "#/properties/parentCommitId/type", keyword: "type", params: { type: schema78.properties.parentCommitId.type } }];
                return false;
              }
              var valid0 = _errs4 === errors;
            } else {
            ...
            if (valid0) {
              if (data.subscriptionId !== void 0) {
                const _errs6 = errors;
                if (typeof data.subscriptionId !== "string") {
                  validate56.errors = [{ instancePath: instancePath + "/subscriptionId", schemaPath: "#/properties/subscriptionId/type", keyword: "type", params: { type: "string" } }];
                  return false;
                }
                var valid0 = _errs6 === errors;
              } else {
              ...
              if (valid0) {
                if (data.threadId !== void 0) {
                  const _errs8 = errors;
                  if (typeof data.threadId !== "string") {
                    validate56.errors = [{ instancePath: instancePath + "/threadId", schemaPath: "#/properties/threadId/type", keyword: "type", params: { type: "string" } }];
                    return false;
                  }
                  var valid0 = _errs8 === errors;
                } else {
      ...
      validate56.errors = [{ instancePath, schemaPath: "#/type", keyword: "type", params: { type: "object" } }];
      return false;
    }
  }
...
function validate72(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  let errors = 0;
  if (!(data && typeof data == "object" && !Array.isArray(data))) {
    validate72.errors = [{ instancePath, schemaPath: "https://openai.com/codex/app-server-protocol.schema.json#/definitions/v2/TurnInterruptResponse/type", keyword: "type", params: { type: "object" } }];
    return false;
  }
