...
import { LocaleRuntimeProvider, useLocaleRuntime } from "./LocaleRuntimeProvider";
...
function RuntimeProbe() {
  ...
  return (
    <section aria-label="Locale runtime">
      ...
      <button type="button" onClick={() => void runtime.setPreference("system")}>
        Use system
      </button>
      <button type="button" onClick={() => void runtime.setPreference("en")}>
        Use English
      </button>
      <button type="button" onClick={() => void runtime.setPreference("zh-CN")}>
