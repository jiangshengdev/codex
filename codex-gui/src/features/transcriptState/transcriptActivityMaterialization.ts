    ...
    case "errored": {
      ...
      return {
        ...
        message:
          message == null
            ? null
            : truncateGraphemes(message, COLLAB_AGENT_ERROR_PREVIEW_GRAPHEMES),
      };
    }
  }
...
const materializeCollabAgentToolCall = (
  ...
  switch (tool) {
        ...
        details: [
          {
            kind: "copy",
            copy:
              state == null ? { kind: "agentResumeFailed" } : agentStatusCopy(null, state),
          },
        ],
      };
    }
    ...
    case "closeAgent": {
      ...
      return receiver == null
        ? null
        : { copy: { kind: "agentClosed", receiver }, details: [] };
    }
  }
