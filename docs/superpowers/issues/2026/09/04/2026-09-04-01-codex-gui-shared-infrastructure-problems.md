...
- `docs/superpowers/issues/2026/09/04/2026-09-04-01-codex-gui-shared-infrastructure-problems/2026-09-04-07-external-store-subscription-duplication.md`: 已修复；10 个生产消费者共用订阅通知工具，保留各自状态与生命周期规则。
- `docs/superpowers/issues/2026/09/04/2026-09-04-01-codex-gui-shared-infrastructure-problems/2026-09-04-08-unknown-error-text-duplication.md`: 已修复；四个生产文件共用错误文本转换，保持原有显示和重试行为。
