...
- Modify: `docs/superpowers/specs/2026/05/19/2026-05-19-test-rust-v0.131.0-projection-migration-design.md` only if implementation reveals a design mismatch.
