...
- Design: `docs/superpowers/specs/2026/05/2026-05-25-projection-attach-lease-design.md`
...
In `docs/superpowers/issues/2026/05/2026-05-19-projection-atomicity-review.md`, change the top status bullet for Finding 2 from open to fixed. Use wording like:
...
```bash
git add docs/superpowers/issues/2026/05/2026-05-19-projection-atomicity-review.md
