...
- `docs/superpowers/plans/2026/05/2026-05-30-gui-host/07-frontend-handshake-store-verification.md`
...
- `docs/superpowers/plans/2026/05/2026-05-30-gui-host/08-*`
...
1. `docs/superpowers/plans/2026/05/2026-05-30-gui-host/00-roadmap.md`
2. `docs/superpowers/specs/2026/05/2026-05-11-codex-gui-host-redesign.md`
3. `docs/superpowers/specs/2026/05/2026-05-30-codex-gui-host-dev-adaptation-design.md`
4. `docs/superpowers/specs/2026/05/2026-05-02-codex-gui-projection-design.md`
5. `docs/superpowers/specs/2026/05/2026-05-08-codex-gui-server-projection-redesign.md`
...
- Verify: `docs/superpowers/plans/2026/05/2026-05-30-gui-host/06-tui-gui-command.md`
- Modify only if recording execution: `docs/superpowers/plans/2026/05/2026-05-30-gui-host/07-frontend-handshake-store-verification.md`
...
rg -n 'codex-gui/\\*\\*|frontend|projection store|browser handshake|属于 `07-frontend-handshake-store-verification.md`|Stop before frontend work' \
  docs/superpowers/plans/2026/05/2026-05-30-gui-host/06-tui-gui-command.md
```
...
- PASS: `00-roadmap.md` places `07` between TUI `/gui` and packaging/e2e.
- PASS: `2026-05-11` design defines frontend scope as projection transport MVP, not projection viewer.
- BLOCKED: `2026-05-30` adaptation design supports bridge shape locked, but missing pattern `frontend|handshake|store verification|07` in `docs/superpowers/specs/2026/05/2026-05-30-codex-gui-host-dev-adaptation-design.md` for frontend verification as a separate step.
- PASS: `06-tui-gui-command.md` stopped before frontend handshake/store verification.
