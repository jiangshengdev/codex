...
Complete and commit `docs/superpowers/plans/2026/05/2026-05-30-gui-host/10-default-network-access-core.md` first.

## Source Design

- `docs/superpowers/specs/2026/06/2026-06-08-codex-gui-host-default-network-access-design.md`
...
- Modify: `docs/superpowers/specs/2026/05/2026-05-11-codex-gui-host-redesign.md`
- Modify: `docs/superpowers/specs/2026/05/2026-05-30-codex-gui-host-dev-adaptation-design.md`
- Modify: `docs/superpowers/plans/2026/05/2026-05-30-gui-host/00-roadmap.md`
...
```bash
rg -n "不支持 LAN|loopback-only|只显示本机 URL|127\\.0\\.0\\.1:0" docs/superpowers/specs/2026/05/2026-05-11-codex-gui-host-redesign.md docs/superpowers/specs/2026/05/2026-05-30-codex-gui-host-dev-adaptation-design.md docs/superpowers/plans/2026/05/2026-05-30-gui-host/00-roadmap.md
```
...
```bash
git add docs/superpowers/specs/2026/05/2026-05-11-codex-gui-host-redesign.md docs/superpowers/specs/2026/05/2026-05-30-codex-gui-host-dev-adaptation-design.md docs/superpowers/plans/2026/05/2026-05-30-gui-host/00-roadmap.md
