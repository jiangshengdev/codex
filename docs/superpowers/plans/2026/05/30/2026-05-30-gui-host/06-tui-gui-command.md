...
- `codex-rs/Cargo.lock`
- `MODULE.bazel.lock`
- `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/07-*`
...
3. `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/05-app-server-client-facade.md`
...
- Verify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/05-app-server-client-facade.md`
