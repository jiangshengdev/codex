...
- `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/03-bridge-boundary-decision.md`
...
- `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/04-*`
...
1. `docs/superpowers/specs/2026/05/30/2026-05-30-codex-gui-host-dev-adaptation-design.md`
2. `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-low-intrusion-refactor-design.md`
3. `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-extra-open-hook-thinning-design.md`
4. `docs/superpowers/specs/2026/05/11/2026-05-11-codex-gui-host-redesign.md`
5. `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/00-roadmap.md`
...
**Files:**
- Verify: `docs/superpowers/specs/2026/05/30/2026-05-30-codex-gui-host-dev-adaptation-design.md`
- Verify: `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-low-intrusion-refactor-design.md`
- Verify: `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-extra-open-hook-thinning-design.md`
- Verify: `docs/superpowers/specs/2026/05/11/2026-05-11-codex-gui-host-redesign.md`
- Verify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/00-roadmap.md`
- Modify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/03-bridge-boundary-decision.md`
...
rg -n '方案 A|选方案 A|计划防漂移锁|已锁定决策|禁止方向|停止条件' \
  docs/superpowers/specs/2026/05/30/2026-05-30-codex-gui-host-dev-adaptation-design.md
```
...
rg -n 'hook 必须保持中性命名|不出现 GUI|不应继续留在 `in_process.rs`|app-server-client/src/lib.rs|不应保留的改动|验收标准' \
  docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-low-intrusion-refactor-design.md
```
...
rg -n '只收窄|只负责 runtime 编排|不再解构这些字段|不再知道 opened state 的字段列表|不直接构造 extra writer bridge|不直接创建 extra connection' \
  docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-extra-open-hook-thinning-design.md
```
...
rg -n '03 bridge boundary decision|04 minimal app-server adapter|01.*03.*关键 gate|没有通过 gate|必须禁止|重写 `rust-v0.136.0` runtime loop' \
  docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/00-roadmap.md
```
...
**Files:**
- Verify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/02-gui-host-crate.md`
...
rg -n 'Stop before bridge work|Allowed next plan after this one|03-bridge-boundary-decision.md|Not allowed as part of this plan' \
  docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/02-gui-host-crate.md
```
...
```bash
git diff --name-only | rg -v '^docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/03-bridge-boundary-decision.md$'
```
