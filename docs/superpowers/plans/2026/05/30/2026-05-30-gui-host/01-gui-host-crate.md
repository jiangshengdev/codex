...
- `docs/superpowers/specs/2026/05/11/2026-05-11-codex-gui-host-redesign.md`
...
- `docs/superpowers/specs/2026/05/02/2026-05-02-codex-gui-projection-design.md`
- `docs/superpowers/specs/2026/05/08/2026-05-08-codex-gui-server-projection-redesign.md`
- `docs/superpowers/specs/2026/05/10/2026-05-10-codex-gui-host-design.md`
...
- Modify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/01-gui-host-crate.md`
...
- Verify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/02-in-process-extra-connection.md`
...
for f in \
  ...
  docs/superpowers/specs/2026/05/02/2026-05-02-codex-gui-projection-design.md \
  docs/superpowers/specs/2026/05/08/2026-05-08-codex-gui-server-projection-redesign.md \
  docs/superpowers/specs/2026/05/10/2026-05-10-codex-gui-host-design.md; do
...
```bash
test ! -e docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/02-in-process-extra-connection.md && echo "old 02 removed"
```
...
**Files:**
- Read: `docs/superpowers/specs/2026/05/11/2026-05-11-codex-gui-host-redesign.md`
- Read: `docs/superpowers/specs/2026/05/30/2026-05-30-codex-gui-host-dev-adaptation-design.md`
- Read: `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-low-intrusion-refactor-design.md`
- Read: `docs/superpowers/specs/2026/05/13/2026-05-13-gui-host-extra-open-hook-thinning-design.md`
- Modify: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/01-gui-host-crate.md`
...
**Files:**
- Read: `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/00-roadmap.md`
...
rg -n "open_extra_jsonrpc_connection|ExtraJsonRpcConnectionFactory|extra in-process connection|in_process_extra" \
  ...
  docs/superpowers/plans/2026/05/30/2026-05-30-gui-host
```
...
```bash
git diff --name-only | rg -v '^docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/01-gui-host-crate.md$'
```
