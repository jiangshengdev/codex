...
**Architecture:** This plan implements `docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md`. The root `@jiangshengdev/codex` package owns `dist/`; `build_npm_package.py --package codex` builds and stages `codex-gui/dist`; the Node wrapper supplies a default `CODEX_GUI_PACKAGE_ROOT` without overriding user-provided values.
...
- `docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md`
- `docs/superpowers/specs/2026/05/11/2026-05-11-codex-gui-host-redesign.md`
- `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/08-packaging-e2e-verification.md`
...
- `docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/09-npm-packaging-implementation.md`: record execution notes only.
...
- Verify: `codex-cli/scripts/build_npm_package.py`
- Verify: `docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md`
...
```bash
pnpm prettier --check codex-cli/bin/codex.js codex-cli/package.json docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/09-npm-packaging-implementation.md
```
...
```bash
git diff -- codex-cli/bin/codex.js codex-cli/package.json codex-cli/scripts/build_npm_package.py docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/09-npm-packaging-implementation.md
```
...
- PASS Task 6: `pnpm prettier --check codex-cli/bin/codex.js codex-cli/package.json docs/superpowers/specs/2026/06/06/2026-06-06-codex-gui-host-npm-packaging-design.md docs/superpowers/plans/2026/05/30/2026-05-30-gui-host/09-npm-packaging-implementation.md` exited 0 after formatting the two docs files; `python3 -m py_compile codex-cli/scripts/build_npm_package.py` exited 0; unintended Rust/frontend source/lockfile diff check exited 0.
