...
- `docs/superpowers/specs/2026/06/17/2026-06-17-yolo-single-session-chat-performance-v2/04a-heroui-chat-shell-design.md`

本计划依赖但不修改:

- `docs/superpowers/specs/2026/06/17/2026-06-17-yolo-single-session-chat-performance-v2/04-chat-shell-style-design.md`
- `docs/superpowers/specs/2026/06/17/2026-06-17-yolo-single-session-chat-performance-v2/03-committed-transcript-surface-design.md`
- `docs/superpowers/plans/2026/06/17/2026-06-17-yolo-single-session-chat-performance-v2/04-chat-shell-style/plan-04-chat-shell-style.md`
...
```bash
sed -n '1,320p' docs/superpowers/specs/2026/06/17/2026-06-17-yolo-single-session-chat-performance-v2/04a-heroui-chat-shell-design.md
```
