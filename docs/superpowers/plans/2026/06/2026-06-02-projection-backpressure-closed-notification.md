...
- Design: `docs/superpowers/specs/2026/06/2026-06-02-projection-backpressure-closed-notification-design.md`
- Issue: `docs/superpowers/issues/2026/05/2026-05-30-01-projection-fanout-silent-invalidation.md`
...
- Modify: `docs/superpowers/issues/2026/05/2026-05-30-01-projection-fanout-silent-invalidation.md`
...
```sh
git diff --check
git diff --stat -- codex-rs/app-server-protocol codex-rs/app-server docs/superpowers/issues/2026/05/2026-05-30-01-projection-fanout-silent-invalidation.md
```
...
After Steps 3-7 pass, append this status note to `docs/superpowers/issues/2026/05/2026-05-30-01-projection-fanout-silent-invalidation.md`:
...
```sh
git add codex-rs/app-server-protocol codex-rs/app-server docs/superpowers/issues/2026/05/2026-05-30-01-projection-fanout-silent-invalidation.md
