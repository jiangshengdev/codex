...
```bash
git add codex-gui/src/features/incrementalChatState/incrementalChatStateSlice.ts codex-gui/src/features/incrementalChatState/__tests__/incrementalChatStateSlice.test.ts docs/superpowers/plans/2026/06/2026-06-16-gui-turn-order-membership.md
