...
- Read only: `docs/superpowers/specs/2026/06/28/2026-06-28-debug-responsive-gui-lan-url-preference-design.md`
...
**Files:**
- Modify: `.codex/skills/debug-responsive-gui/SKILL.md`
- Read: `docs/superpowers/specs/2026/06/28/2026-06-28-debug-responsive-gui-lan-url-preference-design.md`
...
- [ ] **Step 1: Re-read the design and current skill**
  ...
  ```bash
  sed -n '1,220p' docs/superpowers/specs/2026/06/28/2026-06-28-debug-responsive-gui-lan-url-preference-design.md
