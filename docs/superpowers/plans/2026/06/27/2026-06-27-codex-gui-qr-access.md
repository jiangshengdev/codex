...
- The design is saved at `docs/superpowers/specs/2026/06/27/2026-06-27-codex-gui-qr-access-design.md`.
...
```sh
cd /Users/jiangsheng/cnb/codex
git diff -- codex-gui/package.json codex-gui/pnpm-lock.yaml codex-gui/src docs/superpowers/specs/2026/06/27/2026-06-27-codex-gui-qr-access-design.md docs/superpowers/plans/2026/06/27/2026-06-27-codex-gui-qr-access.md
```
...
docs/superpowers/specs/2026/06/27/2026-06-27-codex-gui-qr-access-design.md
docs/superpowers/plans/2026/06/27/2026-06-27-codex-gui-qr-access.md
```
