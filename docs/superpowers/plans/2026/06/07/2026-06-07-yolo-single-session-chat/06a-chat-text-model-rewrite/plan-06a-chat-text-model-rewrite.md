...
The old plan at `docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model/plan-06a-chat-text-model.md` is obsolete and must not be used for implementation.
...
**Files:**
- Modify: `docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model-rewrite/plan-06a-chat-text-model-rewrite.md`
- Optional if implementation changes require it: `docs/superpowers/specs/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model/design.md`
...
```bash
sed -n '1,12p' docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model/plan-06a-chat-text-model.md
```
...
```bash
test -f docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model-rewrite/plan-06a-chat-text-model-rewrite.md
```
...
```bash
rg -n --glob '!**/06a-chat-text-model-rewrite/**' 'from `selectThreadTimelineMaterials\(state\)`|from selectThreadTimelineMaterials|consumes `TimelineMaterial`|The implementation consumes `selectThreadTimelineMaterials\(state\)`' docs/superpowers/specs/2026/06/07/2026-06-07-yolo-single-session-chat docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat
```

Expected result: matches are allowed only in the obsolete plan:

```text
docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model/plan-06a-chat-text-model.md
```
...
pnpm --dir codex-gui run type-check
rg -n "TimelineMaterial|selectThreadTimelineMaterials|liveEventHandling|ThreadItem|UserInput|snapshotTurns|eventBuffer" codex-gui/src/features/chatTextModel
git diff --check -- codex-gui/src/features/chatTextModel docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/06a-chat-text-model-rewrite/plan-06a-chat-text-model-rewrite.md
```
