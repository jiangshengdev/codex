...
- Verify: `docs/superpowers/specs/2026/06/07/2026-06-07-yolo-single-session-chat/05-live-event-handling/design.md`
...
```bash
git add docs/superpowers/plans/2026/06/07/2026-06-07-yolo-single-session-chat/05-live-event-handling/plan-05-live-event-handling.md
