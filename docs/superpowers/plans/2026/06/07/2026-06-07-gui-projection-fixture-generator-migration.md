...
codex-gui/src/features/projection/__fixtures__/event-turn-completed.json
codex-gui/src/features/projection/__fixtures__/event-turn-started.json
docs/superpowers/plans/2026/06/07/2026-06-07-gui-projection-fixture-generator-migration.md
```
...
```bash
git add docs/superpowers/plans/2026/06/07/2026-06-07-gui-projection-fixture-generator-migration.md
