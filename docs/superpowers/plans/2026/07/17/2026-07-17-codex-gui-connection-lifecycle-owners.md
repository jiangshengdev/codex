...
设计依据：[2026-07-17-codex-gui-connection-lifecycle-owners-design.md](../../../../specs/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners-design.md)
...
**Files:**
- Modify: `docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md`
- Stage existing: `docs/superpowers/specs/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners-design.md`
...
```bash
rg -n -e '^状态：待确认$' docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
```
...
```bash
rg -n -e '^状态：已确认$' docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
```
...
```bash
git diff --check -- docs/superpowers/specs/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners-design.md docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
git diff -- docs/superpowers/specs/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners-design.md docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
```
...
```bash
git add -- docs/superpowers/specs/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners-design.md docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
...
```text
docs/superpowers/plans/2026/07/17/2026-07-17-codex-gui-connection-lifecycle-owners.md
...
- Modify: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md`
...
```bash
rg -n -e 'B02 回退状态' -e '当前实施状态.*B02.*回退' docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md
```
...
```bash
git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md
git diff -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md
```
...
```bash
rg -n -e 'B02 完成状态' -e '已实施（B02）' docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md
```
...
```bash
git add -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md
git diff --cached --name-only
git diff --cached --check
git diff --cached
