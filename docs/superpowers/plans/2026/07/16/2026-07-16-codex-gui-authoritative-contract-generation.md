...
git status --short --untracked-files=all -- \
  ...
  docs/superpowers/specs/2026/07/16/2026-07-16-codex-gui-authoritative-contract-generation-design.md
```
...
- Modify after verification: `docs/superpowers/issues/2026/07/16/2026-07-16-01-codex-gui-authoritative-contract-drift.md`
