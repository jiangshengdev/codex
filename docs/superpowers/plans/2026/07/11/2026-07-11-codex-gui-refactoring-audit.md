...
- 执行前阅读 `docs/superpowers/specs/2026/07/11/2026-07-11-codex-gui-refactoring-audit-design.md`。
- 只允许修改 `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md` 至 `09-cross-cutting-boundaries-and-exclusions.md`。
...
- Transcript State 内部拆分只引用 `docs/superpowers/specs/2026/07/11/2026-07-11-codex-gui-transcript-state-split-design.md` 并标记 `已有专项设计`，不得重报。
- 允许把 `docs/superpowers/reports/2026/07/09/2026-07-09-codex-gui-system-performance-check/**` 作为归属引用输入；只在当前代码或既有报告明确关联时读取 `docs/superpowers/issues/**`，不得扩大为 issue 审计。
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/01-app-entry-shell-and-platform.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/01-app-entry-shell-and-platform.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/03-projection-ingress-and-thread-runtime.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/03-projection-ingress-and-thread-runtime.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/04-timeline-materials-and-domain-models.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/04-timeline-materials-and-domain-models.md`
...
- Design: `docs/superpowers/specs/2026/07/11/2026-07-11-codex-gui-transcript-state-split-design.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/05-transcript-state-and-materialization.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/05-transcript-state-and-materialization.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/06-transcript-rendering-streaming-and-scroll.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/06-transcript-rendering-streaming-and-scroll.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/07-composer-access-and-localization.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/07-composer-access-and-localization.md`
...
- Report: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/08-test-infrastructure-fixtures-and-support.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/08-test-infrastructure-fixtures-and-support.md`
...
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/01-app-entry-shell-and-platform.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/02-gui-host-transport-and-protocol.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/03-projection-ingress-and-thread-runtime.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/04-timeline-materials-and-domain-models.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/05-transcript-state-and-materialization.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/06-transcript-rendering-streaming-and-scroll.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/07-composer-access-and-localization.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/08-test-infrastructure-fixtures-and-support.md`
- Read: every path returned by `rg --files codex-gui/src`
- Modify: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/09-cross-cutting-boundaries-and-exclusions.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/09-cross-cutting-boundaries-and-exclusions.md`
...
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/07-composer-access-and-localization.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/08-test-infrastructure-fixtures-and-support.md`
- Read: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/09-cross-cutting-boundaries-and-exclusions.md`
- Modify: `docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md`
...
Validation: `git diff --check -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit/00-summary.md`
...
- `ALL-REPORT-COMMITS-COMPLETE` 只有在以下条件全部满足时释放：
  ...
  - `git status --short -- docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit` 无输出。
...
| node ID | 单一检查 | 命令/证据 |
| --- | --- | --- |
| FR-STATUS | 未完成状态或占位内容 | `rg -n -e '未开始|待审计|尚未审计|PLACEHOLDER' docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit` |
| FR-FINDINGS | ID、固定字段、状态、优先级、owner | `rg -n -e 'Finding ID:|Evidence owner:|状态:|重构优先级:' docs/superpowers/reports/2026/07/11/2026-07-11-codex-gui-refactoring-audit` |
