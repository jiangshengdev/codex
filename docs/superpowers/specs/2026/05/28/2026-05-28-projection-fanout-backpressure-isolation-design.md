...
`docs/superpowers/issues/2026/05/19/2026-05-19-projection-hidden-race-review.md` 的 Finding 2 仍开放：
...
当前 fork 已通过 `docs/superpowers/specs/2026/05/28/2026-05-28-outgoing-message-projection-hook-convergence-design.md`
