...
本设计承接 `docs/superpowers/specs/2026/07/2026-07-16-codex-gui-authoritative-contract-generation-design.md`，不推翻其 Rust authority、`ts-rs`、`schemars`、Ajv standalone、generated drift check 和 GUI Host transport 迁移结论。
