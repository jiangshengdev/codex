...
`docs/superpowers/issues/2026/06/2026-06-30-03-codex-gui-ime-enter-submits-draft.md` 记录了 Codex GUI composer 在真实 macOS 中文输入法下的 Enter 时序问题。现有 browser test 可以模拟 composition/key 事件，但不能覆盖真实系统输入法、候选栏窗口、候选选择和浏览器实际事件顺序。
