...
- `docs/superpowers/specs/2026/07/2026-07-09-codex-gui-system-performance-check-design.md:73`: 空间风险要求 owner、key、生命周期、cleanup 边界。
- `docs/superpowers/specs/2026/07/2026-07-09-codex-gui-system-performance-check-design.md:199`: retained-state-memory 切片范围。
