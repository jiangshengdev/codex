...
- `docs/superpowers/issues/2026/05/2026-05-30-06-export-annotation-last-writer-wins.md:5`、`:13`-`:15` 明确该 issue 仅影响 build-time schema 文档字段，不影响运行时。
