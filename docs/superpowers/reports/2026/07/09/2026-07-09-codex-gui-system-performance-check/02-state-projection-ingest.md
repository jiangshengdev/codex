...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-01-projection-event-top-level-react-state.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-01-projection-event-top-level-react-state.md:23`: 旧记录也指出当前 projection payload 不再推动顶层 lifecycle status。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-08-projection-delta-redux-action-frequency.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-08-projection-delta-redux-action-frequency.md:16`: 旧记录已把 action/subscription 边界改写为 `F` 次 batch flush。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-02-transcript-chunk-selector-view-rebuild.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-02-transcript-chunk-selector-view-rebuild.md:24`-`30`: issue 记录当前代码已用 `WeakMap` + `chunk.revision` 缓存 chunk view。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-03-item-started-dirties-transcript-state.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-03-item-started-dirties-transcript-state.md:52`-`54`: 记录重复 live `itemStarted` 已在 `recordAppliedEvent` 前返回。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-07-transcript-revision-invariant.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-07-transcript-revision-invariant.md:83`-`84`: issue 当前保留为未来新增 entry/字段时的 invariant 风险。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-10-live-slot-selector-cache-invalidation.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-10-live-slot-selector-cache-invalidation.md:14`-`18`: 旧 live selector cache invalidation 表述已过期。
