...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-05-heroui-full-css-import.md`
...
- `docs/superpowers/specs/2026/07/09/2026-07-09-codex-gui-system-performance-check-design.md:123`-`128`: startup-resources 切片口径；CSS/JS 体积只能作为 `非本轮可归因` 或后续量化输入。
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-05-heroui-full-css-import.md:14`-`25`: 既有 issue 关注同步 HeroUI CSS import，判断为待 fresh build 量化。
