...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-09-projection-delta-transient-text-concat.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-09-projection-delta-transient-text-concat.md:26`: issue 明确 text accumulation 与 markdown rendering 分开。
...
- 关联 issue: `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-08-projection-delta-redux-action-frequency.md`; `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-10-live-slot-selector-cache-invalidation.md`
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-10-live-slot-selector-cache-invalidation.md:54`: 旧 read-time materialization 已消除。
...
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-01-projection-event-top-level-react-state.md:14`-`19`: 记录历史 fanout。
- `docs/superpowers/issues/2026/06/23/2026-06-23-01-codex-gui-frontend-performance-hot-paths/2026-06-23-01-projection-event-top-level-react-state.md:23`-`29`: 记录 projection event 不再写入顶层 lifecycle status。
